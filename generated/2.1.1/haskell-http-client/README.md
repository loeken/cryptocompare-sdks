## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `CryptoCompare Market, Index, Reference Data, News and Overview Metrcis API for the Cryptocurrency Industry`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the CryptoCompare Market, Index, Reference Data, News and Overview Metrcis API for the Cryptocurrency Industry API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | cryptocompare-market,-index,-reference-data,-news-and-overview-metrcis-api-for-the-cryptocurrency-industry                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustryConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustryRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Client    | use the "dispatch" functions to send requests       |
| CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Core      | core functions, config and request types            |
| CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.API       | construct api requests                              |
| CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model     | describes api models                                |
| CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.ModelLens | lenses for model fields                             |
| CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Logging   | logging functions and utils                         |
