/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.ReferenceRatesApi.
...
goog.provide('API.Client.ReferenceRatesApi');
 ...
 * @struct
 */
API.Client.ReferenceRatesApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('ReferenceRatesApiBasePath') ?
                   /** @type {!string} */ ($injector.get('ReferenceRatesApiBasePath')) :
                   'https://data-api.cryptocompare.com';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('ReferenceRatesApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('ReferenceRatesApiDefaultHeaders')) :
                   {};
...
API.Client.ReferenceRatesApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 */
API.Client.ReferenceRatesApi.prototype.indexCcV1HistoricalDays = function(market, instrument, opt_groups, opt_limit, opt_toTs, opt_aggregate, opt_fill, opt_mappingPriority, opt_responseFormat, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/index/cc/v1/historical/days';
  ...
  if (!market) {
    throw new Error('Missing required parameter market when calling indexCcV1HistoricalDays');
  }
  // verify required parameter 'instrument' is set
  if (!instrument) {
    throw new Error('Missing required parameter instrument when calling indexCcV1HistoricalDays');
  }
  if (market !== undefined) {
 ...
 * @return {!angular.$q.Promise<!API.Client.GENERIC_RESPONSE>}
 */
API.Client.ReferenceRatesApi.prototype.indexCcV1HistoricalHours = function(market, instrument, opt_groups, opt_limit, opt_toTs, opt_aggregate, opt_fill, opt_mappingPriority, opt_responseFormat, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/index/cc/v1/historical/hours';
  ...
  // verify required parameter 'market' is set
  if (!market) {
    throw new Error('Missing required parameter market when calling indexCcV1HistoricalHours');
  }
  // verify required parameter 'instrument' is set
  if (!instrument) {
    throw new Error('Missing required parameter instrument when calling indexCcV1HistoricalHours');
  }
  if (market !== undefined) {
    queryParameters['market'] = market;
  }
 ...
 * @return {!angular.$q.Promise<!API.Client.GENERIC_RESPONSE>}
 */
API.Client.ReferenceRatesApi.prototype.indexCcV1HistoricalMessages = function(market, instrument, opt_afterTs, opt_lastCcseq, opt_mappingPriority, opt_limit, opt_responseFormat, opt_return404OnEmptyResponse, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/index/cc/v1/historical/messages';
  ...
  // verify required parameter 'market' is set
  if (!market) {
    throw new Error('Missing required parameter market when calling indexCcV1HistoricalMessages');
  }
  // verify required parameter 'instrument' is set
  if (!instrument) {
    throw new Error('Missing required parameter instrument when calling indexCcV1HistoricalMessages');
  }
  if (market !== undefined) {
    queryParameters['market'] = market;
  }
 ...
 * @return {!angular.$q.Promise<!API.Client.GENERIC_RESPONSE>}
 */
API.Client.ReferenceRatesApi.prototype.indexCcV1HistoricalMessagesHour = function(market, instrument, opt_hourTs, opt_mappingPriority, opt_responseFormat, opt_return404OnEmptyResponse, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/index/cc/v1/historical/messages/hour';
  ...
  // verify required parameter 'market' is set
  if (!market) {
    throw new Error('Missing required parameter market when calling indexCcV1HistoricalMessagesHour');
  }
  // verify required parameter 'instrument' is set
  if (!instrument) {
    throw new Error('Missing required parameter instrument when calling indexCcV1HistoricalMessagesHour');
  }
  if (market !== undefined) {
    queryParameters['market'] = market;
  }
 ...
 * @return {!angular.$q.Promise<!API.Client.GENERIC_RESPONSE>}
 */
API.Client.ReferenceRatesApi.prototype.indexCcV1HistoricalMinutes = function(market, instrument, opt_groups, opt_limit, opt_toTs, opt_aggregate, opt_fill, opt_mappingPriority, opt_responseFormat, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/index/cc/v1/historical/minutes';
  ...
  // verify required parameter 'market' is set
  if (!market) {
    throw new Error('Missing required parameter market when calling indexCcV1HistoricalMinutes');
  }
  // verify required parameter 'instrument' is set
  if (!instrument) {
    throw new Error('Missing required parameter instrument when calling indexCcV1HistoricalMinutes');
  }
  if (market !== undefined) {
    queryParameters['market'] = market;
  }
 ...
 * @return {!angular.$q.Promise<!API.Client.GENERIC_RESPONSE>}
 */
API.Client.ReferenceRatesApi.prototype.indexCcV1LatestInstrumentMetadata = function(market, instruments, opt_groups, opt_mappingPriority, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/index/cc/v1/latest/instrument/metadata';
  ...
  // verify required parameter 'market' is set
  if (!market) {
    throw new Error('Missing required parameter market when calling indexCcV1LatestInstrumentMetadata');
  }
  // verify required parameter 'instruments' is set
  if (!instruments) {
    throw new Error('Missing required parameter instruments when calling indexCcV1LatestInstrumentMetadata');
  }
  if (market !== undefined) {
    queryParameters['market'] = market;
  }
 ...
 * @return {!angular.$q.Promise<!API.Client.GENERIC_RESPONSE>}
 */
API.Client.ReferenceRatesApi.prototype.indexCcV1LatestTick = function(market, instruments, opt_groups, opt_mappingPriority, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/index/cc/v1/latest/tick';
  ...
  // verify required parameter 'market' is set
  if (!market) {
    throw new Error('Missing required parameter market when calling indexCcV1LatestTick');
  }
  // verify required parameter 'instruments' is set
  if (!instruments) {
    throw new Error('Missing required parameter instruments when calling indexCcV1LatestTick');
  }
  if (market !== undefined) {
    queryParameters['market'] = market;
  }
 ...
 * @return {!angular.$q.Promise<!API.Client.GENERIC_RESPONSE>}
 */
API.Client.ReferenceRatesApi.prototype.indexCcV1Markets = function(opt_market, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/index/cc/v1/markets';
 ...
 * @return {!angular.$q.Promise<!API.Client.GENERIC_RESPONSE>}
 */
API.Client.ReferenceRatesApi.prototype.indexCcV1MarketsInstruments = function(opt_market, opt_instrument, opt_instrumentStatus, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/index/cc/v1/markets/instruments';
 ...
 * @return {!angular.$q.Promise<!API.Client.GENERIC_RESPONSE>}
 */
API.Client.ReferenceRatesApi.prototype.indexCcV1MarketsInstrumentsUnmapped = function(opt_market, opt_instrument, opt_instrumentStatus, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/index/cc/v1/markets/instruments/unmapped';
