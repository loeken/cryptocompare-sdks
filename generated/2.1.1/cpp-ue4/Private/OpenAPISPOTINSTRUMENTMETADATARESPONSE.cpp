...
void OpenAPISPOTINSTRUMENTMETADATARESPONSE::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISPOTINSTRUMENTMETADATARESPONSE::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
