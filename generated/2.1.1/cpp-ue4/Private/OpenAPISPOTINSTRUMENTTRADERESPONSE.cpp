...
void OpenAPISPOTINSTRUMENTTRADERESPONSE::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISPOTINSTRUMENTTRADERESPONSE::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
