...
void OpenAPISPOTINSTRUMENTMARKETDATARESPONSEErrOtherInfo::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISPOTINSTRUMENTMARKETDATARESPONSEErrOtherInfo::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
