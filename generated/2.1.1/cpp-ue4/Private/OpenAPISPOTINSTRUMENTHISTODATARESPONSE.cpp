...
void OpenAPISPOTINSTRUMENTHISTODATARESPONSE::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISPOTINSTRUMENTHISTODATARESPONSE::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
