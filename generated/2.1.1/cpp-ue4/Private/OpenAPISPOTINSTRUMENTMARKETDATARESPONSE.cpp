...
void OpenAPISPOTINSTRUMENTMARKETDATARESPONSE::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISPOTINSTRUMENTMARKETDATARESPONSE::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
