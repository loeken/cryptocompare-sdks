...
/**
 * Parameters for spot_v1_markets_instruments_unmapped
 */
class SpotV1MarketsInstrumentsUnmappedParameterData
{
    /**
     ...
     * @DTA\Strategy(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="QueryStringScalar", options={"type":"string"})
     * @DTA\Validator(subset="query", name="StringLength", options={"min":0, "max":300})
     * @var string|null
     */
    public $instrument;
