...
```java
Mono<GENERICRESPONSE> ReferenceRatesApi.indexCcV1HistoricalDays(marketinstrumentgroupslimittoTsaggregatefillmappingPriorityresponseFormat)
```
...
```java
Mono<GENERICRESPONSE> ReferenceRatesApi.indexCcV1HistoricalHours(marketinstrumentgroupslimittoTsaggregatefillmappingPriorityresponseFormat)
```
...
```java
Mono<GENERICRESPONSE> ReferenceRatesApi.indexCcV1HistoricalMessages(marketinstrumentafterTslastCcseqmappingPrioritylimitresponseFormatreturn404OnEmptyResponse)
```
...
```java
Mono<GENERICRESPONSE> ReferenceRatesApi.indexCcV1HistoricalMessagesHour(marketinstrumenthourTsmappingPriorityresponseFormatreturn404OnEmptyResponse)
```
...
```java
Mono<GENERICRESPONSE> ReferenceRatesApi.indexCcV1HistoricalMinutes(marketinstrumentgroupslimittoTsaggregatefillmappingPriorityresponseFormat)
```
...
```java
Mono<GENERICRESPONSE> ReferenceRatesApi.indexCcV1LatestInstrumentMetadata(marketinstrumentsgroupsmappingPriority)
```
...
# **indexCcV1LatestTick**
```java
Mono<GENERICRESPONSE> ReferenceRatesApi.indexCcV1LatestTick(marketinstrumentsgroupsmappingPriority)
```
