...
public interface ReferenceRatesApi {
     ...
     */
    @Get(uri="/index/cc/v1/historical/days")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> indexCcV1HistoricalDays(
     ...
     * @return GENERICRESPONSE
     */
    @Get(uri="/index/cc/v1/historical/hours")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> indexCcV1HistoricalHours(
        @QueryValue(value="market") @NotNull @Size(min=2, max=30) String market, 
        @QueryValue(value="instrument") @NotNull @Size(min=1, max=500) String instrument, 
        @QueryValue(value="groups", defaultValue="") @Nullable List<String> groups, 
     ...
     * @return GENERICRESPONSE
     */
    @Get(uri="/index/cc/v1/historical/messages")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> indexCcV1HistoricalMessages(
        @QueryValue(value="market") @NotNull @Size(min=2, max=30) String market, 
        @QueryValue(value="instrument") @NotNull @Size(min=1, max=500) String instrument, 
     ...
     * @return GENERICRESPONSE
     */
    @Get(uri="/index/cc/v1/historical/messages/hour")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> indexCcV1HistoricalMessagesHour(
        @QueryValue(value="market") @NotNull @Size(min=2, max=30) String market, 
        @QueryValue(value="instrument") @NotNull @Size(min=1, max=500) String instrument, 
     ...
     * @return GENERICRESPONSE
     */
    @Get(uri="/index/cc/v1/historical/minutes")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> indexCcV1HistoricalMinutes(
        @QueryValue(value="market") @NotNull @Size(min=2, max=30) String market, 
        @QueryValue(value="instrument") @NotNull @Size(min=1, max=500) String instrument, 
        @QueryValue(value="groups", defaultValue="") @Nullable List<String> groups, 
        @QueryValue(value="limit", defaultValue="30") @Nullable @Min(1) @Max(2000) Integer limit, 
     ...
     * @return GENERICRESPONSE
     */
    @Get(uri="/index/cc/v1/latest/instrument/metadata")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> indexCcV1LatestInstrumentMetadata(
        @QueryValue(value="market") @NotNull @Size(min=2, max=30) String market, 
     ...
     * @return GENERICRESPONSE
     */
    @Get(uri="/index/cc/v1/latest/tick")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> indexCcV1LatestTick(
        @QueryValue(value="market") @NotNull @Size(min=2, max=30) String market, 
        @QueryValue(value="instruments") @NotNull @Size(min=1, max=25) List<String> instruments, 
        @QueryValue(value="groups", defaultValue="") @Nullable List<String> groups, 
        @QueryValue(value="mapping_priority", defaultValue="CHECK_MAPPED_FIRST") @Nullable String mappingPriority
     ...
     * @return GENERICRESPONSE
     */
    @Get(uri="/index/cc/v1/markets")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> indexCcV1Markets(
     ...
     * @return GENERICRESPONSE
     */
    @Get(uri="/index/cc/v1/markets/instruments")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> indexCcV1MarketsInstruments(
        @QueryValue(value="market", defaultValue="") @Nullable @Size(min=0, max=30) String market, 
     ...
     * @return GENERICRESPONSE
     */
    @Get(uri="/index/cc/v1/markets/instruments/unmapped")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> indexCcV1MarketsInstrumentsUnmapped(
        @QueryValue(value="market", defaultValue="") @Nullable @Size(min=0, max=30) String market, 
        @QueryValue(value="instrument", defaultValue="") @Nullable @Size(min=0, max=30) String instrument, 
        @QueryValue(value="instrument_status", defaultValue="") @Nullable List<String> instrumentStatus
    );
