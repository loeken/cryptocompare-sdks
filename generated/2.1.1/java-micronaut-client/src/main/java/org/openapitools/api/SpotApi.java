...
public interface SpotApi {
     ...
     */
    @Get(uri="/spot/v1/historical/days")
    @Consumes({"application/json"})
    Mono<SPOTINSTRUMENTHISTODATARESPONSE> spotV1HistoricalDays(
     ...
     * @return SPOTINSTRUMENTHISTODATARESPONSE
     */
    @Get(uri="/spot/v1/historical/hours")
    @Consumes({"application/json"})
    Mono<SPOTINSTRUMENTHISTODATARESPONSE> spotV1HistoricalHours(
        @QueryValue(value="market") @NotNull @Size(min=2, max=30) String market, 
        @QueryValue(value="instrument") @NotNull @Size(min=1, max=500) String instrument, 
        @QueryValue(value="groups", defaultValue="") @Nullable List<String> groups, 
     ...
     * @return SPOTINSTRUMENTHISTODATARESPONSE
     */
    @Get(uri="/spot/v1/historical/minutes")
    @Consumes({"application/json"})
    Mono<SPOTINSTRUMENTHISTODATARESPONSE> spotV1HistoricalMinutes(
        @QueryValue(value="market") @NotNull @Size(min=2, max=30) String market, 
        @QueryValue(value="instrument") @NotNull @Size(min=1, max=500) String instrument, 
        @QueryValue(value="groups", defaultValue="") @Nullable List<String> groups, 
        @QueryValue(value="limit", defaultValue="30") @Nullable @Min(1) @Max(2000) Integer limit, 
     ...
     */
    @Get(uri="/spot/v1/historical/orderbook/l2/snapshot/minute")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> spotV1HistoricalOrderbookL2SnapshotMinute(
        @QueryValue(value="market") @NotNull @Size(min=2, max=30) String market, 
        @QueryValue(value="instrument") @NotNull @Size(min=1, max=500) String instrument, 
        @QueryValue(value="minute_ts") @NotNull Integer minuteTs, 
        @QueryValue(value="depth", defaultValue="50") @Nullable @Min(1) @Max(20000) Integer depth, 
        @QueryValue(value="mapping_priority", defaultValue="CHECK_MAPPED_FIRST") @Nullable String mappingPriority, 
        @QueryValue(value="response_format", defaultValue="JSON") @Nullable String responseFormat
    );
     ...
     */
    @Get(uri="/spot/v1/historical/trades")
    @Consumes({"application/json"})
    Mono<SPOTINSTRUMENTTRADERESPONSE> spotV1HistoricalTrades(
        @QueryValue(value="market") @NotNull @Size(min=2, max=30) String market, 
        @QueryValue(value="instrument") @NotNull @Size(min=1, max=500) String instrument, 
     ...
     * @return SPOTINSTRUMENTTRADERESPONSE
     */
    @Get(uri="/spot/v1/historical/trades/hour")
    @Consumes({"application/json"})
    Mono<SPOTINSTRUMENTTRADERESPONSE> spotV1HistoricalTradesHour(
        @QueryValue(value="market") @NotNull @Size(min=2, max=30) String market, 
        @QueryValue(value="instrument") @NotNull @Size(min=1, max=500) String instrument, 
     ...
     */
    @Get(uri="/spot/v1/latest/instrument/metadata")
    @Consumes({"application/json"})
    Mono<SPOTINSTRUMENTMETADATARESPONSE> spotV1LatestInstrumentMetadata(
        @QueryValue(value="market") @NotNull @Size(min=2, max=30) String market, 
     ...
     */
    @Get(uri="/spot/v1/latest/tick")
    @Consumes({"application/json"})
    Mono<SPOTINSTRUMENTMARKETDATARESPONSE> spotV1LatestTick(
        @QueryValue(value="market") @NotNull @Size(min=2, max=30) String market, 
        @QueryValue(value="instruments") @NotNull @Size(min=1, max=25) List<String> instruments, 
        @QueryValue(value="groups", defaultValue="") @Nullable List<String> groups, 
        @QueryValue(value="mapping_priority", defaultValue="CHECK_MAPPED_FIRST") @Nullable String mappingPriority
     ...
     * @return GENERICRESPONSE
     */
    @Get(uri="/spot/v1/markets")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> spotV1Markets(
     ...
     * @return GENERICRESPONSE
     */
    @Get(uri="/spot/v1/markets/instruments")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> spotV1MarketsInstruments(
        @QueryValue(value="market", defaultValue="") @Nullable @Size(min=0, max=30) String market, 
        @QueryValue(value="instrument", defaultValue="") @Nullable @Size(min=0, max=30) String instrument, 
        @QueryValue(value="instrument_status", defaultValue="ACTIVE,IGNORED,RETIRED,EXPIRED") @Nullable List<String> instrumentStatus
    );
     ...
     * @return GENERICRESPONSE
     */
    @Get(uri="/spot/v1/markets/instruments/unmapped")
    @Consumes({"application/json"})
    Mono<GENERICRESPONSE> spotV1MarketsInstrumentsUnmapped(
        @QueryValue(value="market", defaultValue="") @Nullable @Size(min=0, max=30) String market, 
        @QueryValue(value="instrument", defaultValue="") @Nullable @Size(min=0, max=300) String instrument, 
        @QueryValue(value="instrument_status", defaultValue="ACTIVE,IGNORED,RETIRED,EXPIRED") @Nullable List<String> instrumentStatus
    );
