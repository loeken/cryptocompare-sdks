...
#ifndef TINY_CPP_CLIENT_SPOT_INSTRUMENT_HISTO_DATA_H_
#define TINY_CPP_CLIENT_SPOT_INSTRUMENT_HISTO_DATA_H_
...
public:
    ...
    SPOT_INSTRUMENT_HISTO_DATA(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SPOT_INSTRUMENT_HISTO_DATA_H_ */
