...
#ifndef TINY_CPP_CLIENT_SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_H_
#define TINY_CPP_CLIENT_SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_H_
...
class SPOT_INSTRUMENT_MARKET_DATA_RESPONSE{
public:

    /*! \brief Constructor.
	 */
    SPOT_INSTRUMENT_MARKET_DATA_RESPONSE();
    SPOT_INSTRUMENT_MARKET_DATA_RESPONSE(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~SPOT_INSTRUMENT_MARKET_DATA_RESPONSE();
...
#endif /* TINY_CPP_CLIENT_SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_H_ */
