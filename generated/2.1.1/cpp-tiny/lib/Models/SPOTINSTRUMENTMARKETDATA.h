...
#ifndef TINY_CPP_CLIENT_SPOT_INSTRUMENT_MARKET_DATA_H_
#define TINY_CPP_CLIENT_SPOT_INSTRUMENT_MARKET_DATA_H_
...
public:
    ...
    SPOT_INSTRUMENT_MARKET_DATA(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SPOT_INSTRUMENT_MARKET_DATA_H_ */
