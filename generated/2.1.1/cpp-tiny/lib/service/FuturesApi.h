#ifndef TINY_CPP_CLIENT_FuturesApi_H_
#define TINY_CPP_CLIENT_FuturesApi_H_
...
class FuturesApi : public Service {
public:
    FuturesApi() = default;

    virtual ~FuturesApi() = default;
...
#endif /* TINY_CPP_CLIENT_FuturesApi_H_ */