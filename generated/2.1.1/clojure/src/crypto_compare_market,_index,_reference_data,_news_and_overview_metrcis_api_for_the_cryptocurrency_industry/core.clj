(ns crypto-compare-market,-index,-reference-data,-news-and-overview-metrcis-api-for-the-cryptocurrency-industry.core
...
(def auth-definitions
  {"api_key_header" {:type :api-key :in :header :param-name "authorization"}
   "api_key_query" {:type :api-key :in :query :param-name "api_key"}})
