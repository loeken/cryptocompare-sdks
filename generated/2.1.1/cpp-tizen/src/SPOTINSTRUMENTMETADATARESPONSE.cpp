...
void
SPOT_INSTRUMENT_METADATA_RESPONSE::__init()
{
...
void
SPOT_INSTRUMENT_METADATA_RESPONSE::__cleanup()
{
	//if(data != NULL) {
	//data.RemoveAll(true);
	//delete data;
...
void
SPOT_INSTRUMENT_METADATA_RESPONSE::fromJson(char* jsonStr)
{
...
SPOT_INSTRUMENT_METADATA_RESPONSE::SPOT_INSTRUMENT_METADATA_RESPONSE(char* json)
{
	this->fromJson(json);
}
...
void
SPOT_INSTRUMENT_METADATA_RESPONSE::setData(std::map <string, string> data)
{
	this->data = data;
}
