...
#
package WWW::OpenAPIClient::FuturesApi;
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_days' } = {
        summary => '',
        params => $params,
...
#
sub futures_v1_historical_days {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_days");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_days");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/days';
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_funding_rate_days' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_funding_rate_days {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_funding_rate_days");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_funding_rate_days");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/funding-rate/days';
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_funding_rate_hours' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_funding_rate_hours {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_funding_rate_hours");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_funding_rate_hours");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/funding-rate/hours';
...
# @param boolean $return_404_on_empty_response If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats. (optional, default to false)
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_funding_rate_messages' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_funding_rate_messages {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_funding_rate_messages");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_funding_rate_messages");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/funding-rate-messages';
...
# @param boolean $return_404_on_empty_response If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats. (optional, default to false)
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_funding_rate_messages_hour' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_funding_rate_messages_hour {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_funding_rate_messages_hour");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_funding_rate_messages_hour");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/funding-rate-messages/hour';
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_funding_rate_minutes' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_funding_rate_minutes {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_funding_rate_minutes");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_funding_rate_minutes");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/funding-rate/minutes';
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_hours' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_hours {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_hours");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_hours");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/hours';
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_minutes' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_minutes {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_minutes");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_minutes");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/minutes';
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_open_interest_days' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_open_interest_days {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_open_interest_days");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_open_interest_days");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/open-interest/days';
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_open_interest_hours' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_open_interest_hours {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_open_interest_hours");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_open_interest_hours");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/open-interest/hours';
...
# @param boolean $return_404_on_empty_response If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats. (optional, default to false)
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_open_interest_messages' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_open_interest_messages {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_open_interest_messages");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_open_interest_messages");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/open-interest-messages';
...
# @param boolean $return_404_on_empty_response If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats. (optional, default to false)
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_open_interest_messages_hour' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_open_interest_messages_hour {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_open_interest_messages_hour");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_open_interest_messages_hour");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/open-interest-messages/hour';
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_open_interest_minutes' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_open_interest_minutes {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_open_interest_minutes");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_open_interest_minutes");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/open-interest/minutes';
...
# @param boolean $return_404_on_empty_response If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats. (optional, default to false)
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_trades' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_trades {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_trades");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_trades");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/trades';
...
# @param boolean $return_404_on_empty_response If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats. (optional, default to false)
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_historical_trades_hour' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_historical_trades_hour {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_historical_trades_hour");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling futures_v1_historical_trades_hour");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/historical/trades/hour';
...
# @param string $mapping_priority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST (optional, default to 'CHECK_MAPPED_FIRST')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_latest_funding_rate_tick' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_latest_funding_rate_tick {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_latest_funding_rate_tick");
    }

    # verify the required parameter 'instruments' is set
    unless (exists $args{'instruments'}) {
      croak("Missing the required parameter 'instruments' when calling futures_v1_latest_funding_rate_tick");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/latest/funding-rate/tick';
...
# @param string $mapping_priority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST (optional, default to 'CHECK_MAPPED_FIRST')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_latest_instrument_metadata' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_latest_instrument_metadata {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_latest_instrument_metadata");
    }

    # verify the required parameter 'instruments' is set
    unless (exists $args{'instruments'}) {
      croak("Missing the required parameter 'instruments' when calling futures_v1_latest_instrument_metadata");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/latest/instrument/metadata';
...
# @param string $mapping_priority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST (optional, default to 'CHECK_MAPPED_FIRST')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_latest_open_interest_tick' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_latest_open_interest_tick {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_latest_open_interest_tick");
    }

    # verify the required parameter 'instruments' is set
    unless (exists $args{'instruments'}) {
      croak("Missing the required parameter 'instruments' when calling futures_v1_latest_open_interest_tick");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/latest/open-interest/tick';
...
# @param string $mapping_priority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST (optional, default to 'CHECK_MAPPED_FIRST')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_latest_tick' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_latest_tick {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling futures_v1_latest_tick");
    }

    # verify the required parameter 'instruments' is set
    unless (exists $args{'instruments'}) {
      croak("Missing the required parameter 'instruments' when calling futures_v1_latest_tick");
    }

    # parse inputs
    my $_resource_path = '/futures/v1/latest/tick';
...
# @param string $market The exchange to obtain data from (optional, default to '')
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_markets' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_markets {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/futures/v1/markets';
...
# @param ARRAY[string] $instrument_status The status of the instrument, can be one of the following: ACTIVE, IGNORED, RETIRED, EXPIRED (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_markets_instruments' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_markets_instruments {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/futures/v1/markets/instruments';
...
# @param ARRAY[string] $instrument_status The status of the instrument, can be one of the following: ACTIVE, IGNORED, RETIRED, EXPIRED (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'futures_v1_markets_instruments_unmapped' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub futures_v1_markets_instruments_unmapped {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/futures/v1/markets/instruments/unmapped';
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'index_v1_historical_days' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub index_v1_historical_days {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling index_v1_historical_days");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling index_v1_historical_days");
    }

    # parse inputs
    my $_resource_path = '/index/v1/historical/days';
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'index_v1_historical_hours' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub index_v1_historical_hours {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling index_v1_historical_hours");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling index_v1_historical_hours");
    }

    # parse inputs
    my $_resource_path = '/index/v1/historical/hours';
...
# @param boolean $return_404_on_empty_response If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats. (optional, default to false)
{
    ...
    __PACKAGE__->method_documentation->{ 'index_v1_historical_messages' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub index_v1_historical_messages {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling index_v1_historical_messages");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling index_v1_historical_messages");
    }

    # parse inputs
    my $_resource_path = '/index/v1/historical/messages';
...
# @param boolean $return_404_on_empty_response If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats. (optional, default to false)
{
    ...
    __PACKAGE__->method_documentation->{ 'index_v1_historical_messages_hour' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub index_v1_historical_messages_hour {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling index_v1_historical_messages_hour");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling index_v1_historical_messages_hour");
    }

    # parse inputs
    my $_resource_path = '/index/v1/historical/messages/hour';
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'index_v1_historical_minutes' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub index_v1_historical_minutes {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling index_v1_historical_minutes");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling index_v1_historical_minutes");
    }

    # parse inputs
    my $_resource_path = '/index/v1/historical/minutes';
...
# @param string $mapping_priority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST (optional, default to 'CHECK_MAPPED_FIRST')
{
    ...
    __PACKAGE__->method_documentation->{ 'index_v1_latest_instrument_metadata' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub index_v1_latest_instrument_metadata {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling index_v1_latest_instrument_metadata");
    }

    # verify the required parameter 'instruments' is set
    unless (exists $args{'instruments'}) {
      croak("Missing the required parameter 'instruments' when calling index_v1_latest_instrument_metadata");
    }

    # parse inputs
    my $_resource_path = '/index/v1/latest/instrument/metadata';
...
# @param string $mapping_priority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST (optional, default to 'CHECK_MAPPED_FIRST')
{
    ...
    __PACKAGE__->method_documentation->{ 'index_v1_latest_tick' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub index_v1_latest_tick {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling index_v1_latest_tick");
    }

    # verify the required parameter 'instruments' is set
    unless (exists $args{'instruments'}) {
      croak("Missing the required parameter 'instruments' when calling index_v1_latest_tick");
    }

    # parse inputs
    my $_resource_path = '/index/v1/latest/tick';
...
# @param string $market The exchange to obtain data from (optional, default to '')
{
    ...
    __PACKAGE__->method_documentation->{ 'index_v1_markets' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub index_v1_markets {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/index/v1/markets';
...
# @param ARRAY[string] $instrument_status The status of the instrument, can be one of the following: ACTIVE, IGNORED, RETIRED, EXPIRED (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'index_v1_markets_instruments' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub index_v1_markets_instruments {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/index/v1/markets/instruments';
...
# @param ARRAY[string] $instrument_status The status of the instrument, can be one of the following: ACTIVE, IGNORED, RETIRED, EXPIRED (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'index_v1_markets_instruments_unmapped' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub index_v1_markets_instruments_unmapped {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/index/v1/markets/instruments/unmapped';
