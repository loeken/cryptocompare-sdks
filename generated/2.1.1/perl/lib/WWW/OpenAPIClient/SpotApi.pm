...
#
package WWW::OpenAPIClient::SpotApi;
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'spot_v1_historical_days' } = {
        summary => '',
        params => $params,
        returns => 'SPOTINSTRUMENTHISTODATARESPONSE',
        };
}
# @return SPOTINSTRUMENTHISTODATARESPONSE
#
sub spot_v1_historical_days {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling spot_v1_historical_days");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling spot_v1_historical_days");
    }

    # parse inputs
    my $_resource_path = '/spot/v1/historical/days';
    ...
    my $_response_object = $self->{api_client}->deserialize('SPOTINSTRUMENTHISTODATARESPONSE', $response);
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'spot_v1_historical_hours' } = {
        summary => '',
        params => $params,
        returns => 'SPOTINSTRUMENTHISTODATARESPONSE',
        };
...
# @return SPOTINSTRUMENTHISTODATARESPONSE
#
sub spot_v1_historical_hours {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling spot_v1_historical_hours");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling spot_v1_historical_hours");
    }

    # parse inputs
    my $_resource_path = '/spot/v1/historical/hours';
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'spot_v1_historical_minutes' } = {
        summary => '',
        params => $params,
        returns => 'SPOTINSTRUMENTHISTODATARESPONSE',
        };
...
# @return SPOTINSTRUMENTHISTODATARESPONSE
#
sub spot_v1_historical_minutes {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling spot_v1_historical_minutes");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling spot_v1_historical_minutes");
    }

    # parse inputs
    my $_resource_path = '/spot/v1/historical/minutes';
...
# @param string $response_format The format of the data response in uppercase. It can be one of the following: JSON,CSV (optional, default to 'JSON')
{
    ...
    __PACKAGE__->method_documentation->{ 'spot_v1_historical_orderbook_l2_snapshot_minute' } = {
        summary => '',
        params => $params,
...
#
sub spot_v1_historical_orderbook_l2_snapshot_minute {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling spot_v1_historical_orderbook_l2_snapshot_minute");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling spot_v1_historical_orderbook_l2_snapshot_minute");
    }

    # verify the required parameter 'minute_ts' is set
    unless (exists $args{'minute_ts'}) {
      croak("Missing the required parameter 'minute_ts' when calling spot_v1_historical_orderbook_l2_snapshot_minute");
    }

    # parse inputs
    my $_resource_path = '/spot/v1/historical/orderbook/l2/snapshot/minute';
    ...
    # query params
    if ( exists $args{'minute_ts'}) {
        $query_params->{'minute_ts'} = $self->{api_client}->to_query_value($args{'minute_ts'});
    }
...
# @param boolean $return_404_on_empty_response If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats. (optional, default to false)
{
    ...
    __PACKAGE__->method_documentation->{ 'spot_v1_historical_trades' } = {
        summary => '',
        params => $params,
        returns => 'SPOTINSTRUMENTTRADERESPONSE',
        };
}
# @return SPOTINSTRUMENTTRADERESPONSE
#
sub spot_v1_historical_trades {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling spot_v1_historical_trades");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling spot_v1_historical_trades");
    }

    # parse inputs
    my $_resource_path = '/spot/v1/historical/trades';
    ...
    my $_response_object = $self->{api_client}->deserialize('SPOTINSTRUMENTTRADERESPONSE', $response);
    return $_response_object;
}
...
# @param boolean $return_404_on_empty_response If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats. (optional, default to false)
{
    ...
    __PACKAGE__->method_documentation->{ 'spot_v1_historical_trades_hour' } = {
        summary => '',
        params => $params,
        returns => 'SPOTINSTRUMENTTRADERESPONSE',
        };
...
# @return SPOTINSTRUMENTTRADERESPONSE
#
sub spot_v1_historical_trades_hour {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling spot_v1_historical_trades_hour");
    }

    # verify the required parameter 'instrument' is set
    unless (exists $args{'instrument'}) {
      croak("Missing the required parameter 'instrument' when calling spot_v1_historical_trades_hour");
    }

    # parse inputs
    my $_resource_path = '/spot/v1/historical/trades/hour';
...
# @param string $mapping_priority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST (optional, default to 'CHECK_MAPPED_FIRST')
{
    ...
    __PACKAGE__->method_documentation->{ 'spot_v1_latest_instrument_metadata' } = {
        summary => '',
        params => $params,
        returns => 'SPOTINSTRUMENTMETADATARESPONSE',
        };
}
# @return SPOTINSTRUMENTMETADATARESPONSE
#
sub spot_v1_latest_instrument_metadata {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling spot_v1_latest_instrument_metadata");
    }

    # verify the required parameter 'instruments' is set
    unless (exists $args{'instruments'}) {
      croak("Missing the required parameter 'instruments' when calling spot_v1_latest_instrument_metadata");
    }

    # parse inputs
    my $_resource_path = '/spot/v1/latest/instrument/metadata';
    ...
    my $_response_object = $self->{api_client}->deserialize('SPOTINSTRUMENTMETADATARESPONSE', $response);
    return $_response_object;
}
...
# @param string $mapping_priority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST (optional, default to 'CHECK_MAPPED_FIRST')
{
    ...
    __PACKAGE__->method_documentation->{ 'spot_v1_latest_tick' } = {
        summary => '',
        params => $params,
        returns => 'SPOTINSTRUMENTMARKETDATARESPONSE',
        };
}
# @return SPOTINSTRUMENTMARKETDATARESPONSE
#
sub spot_v1_latest_tick {
    my ($self, %args) = @_;

    # verify the required parameter 'market' is set
    unless (exists $args{'market'}) {
      croak("Missing the required parameter 'market' when calling spot_v1_latest_tick");
    }

    # verify the required parameter 'instruments' is set
    unless (exists $args{'instruments'}) {
      croak("Missing the required parameter 'instruments' when calling spot_v1_latest_tick");
    }

    # parse inputs
    my $_resource_path = '/spot/v1/latest/tick';
    ...
    my $_response_object = $self->{api_client}->deserialize('SPOTINSTRUMENTMARKETDATARESPONSE', $response);
    return $_response_object;
}
...
# @param string $market The exchange to obtain data from (optional, default to '')
{
    ...
    __PACKAGE__->method_documentation->{ 'spot_v1_markets' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
sub spot_v1_markets {
    ...
    # parse inputs
    my $_resource_path = '/spot/v1/markets';
...
# @param ARRAY[string] $instrument_status The status of the instrument, can be one of the following: ACTIVE, IGNORED, RETIRED, EXPIRED (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'spot_v1_markets_instruments' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub spot_v1_markets_instruments {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/spot/v1/markets/instruments';
...
# @param ARRAY[string] $instrument_status The status of the instrument, can be one of the following: ACTIVE, IGNORED, RETIRED, EXPIRED (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'spot_v1_markets_instruments_unmapped' } = {
        summary => '',
        params => $params,
        returns => 'GENERICRESPONSE',
        };
...
# @return GENERICRESPONSE
#
sub spot_v1_markets_instruments_unmapped {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/spot/v1/markets/instruments/unmapped';
