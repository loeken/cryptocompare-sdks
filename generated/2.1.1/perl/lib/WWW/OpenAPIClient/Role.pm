...
has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'CryptoCompare Market, Index, Reference Data, News and Overview Metrcis API for the Cryptocurrency Industry',
                          app_version => '2.1.1',
...
=head2 CryptoCompare Market, Index, Reference Data, News and Overview Metrcis API for the Cryptocurrency Industry version: 2.1.1
