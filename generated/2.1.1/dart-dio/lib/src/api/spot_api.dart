...
class SpotApi {
  ...
  const SpotApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [SPOTINSTRUMENTHISTODATARESPONSE] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SPOTINSTRUMENTHISTODATARESPONSE>> spotV1HistoricalDays({ 
    ...
    final _path = r'/spot/v1/historical/days';
    ...
    SPOTINSTRUMENTHISTODATARESPONSE _responseData;

    try {
      const _responseType = FullType(SPOTINSTRUMENTHISTODATARESPONSE);
    ...
    return Response<SPOTINSTRUMENTHISTODATARESPONSE>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [SPOTINSTRUMENTHISTODATARESPONSE] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SPOTINSTRUMENTHISTODATARESPONSE>> spotV1HistoricalHours({ 
    required String market,
    required String instrument,
    BuiltList<String>? groups,
    int? limit = 30,
    ...
    final _path = r'/spot/v1/historical/hours';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [SPOTINSTRUMENTHISTODATARESPONSE] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SPOTINSTRUMENTHISTODATARESPONSE>> spotV1HistoricalMinutes({ 
    required String market,
    required String instrument,
    BuiltList<String>? groups,
    int? limit = 30,
    ...
    final _path = r'/spot/v1/historical/minutes';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [market] - The exchange to obtain data from
  /// * [instrument] - The mapped or unmapped instrument to retrieve on a specific market. We first check the instrument against the mapped list and then against the unmapped list          but you can use the mapping_priority param to check the unmapped list first.
  /// * [minuteTs] - Unix timestamp in seconds for the minute of the orderbook snapshot you are interested in. You can pass any timestamp within a minute but we will round it down the the full minute timestmap and return the orderbook l2 snapshot at that minute.
  /// * [depth] - The number of top bids and asks to return.
  /// * [mappingPriority] - The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST
  /// * [responseFormat] - The format of the data response in uppercase. It can be one of the following: JSON,CSV
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GENERICRESPONSE>> spotV1HistoricalOrderbookL2SnapshotMinute({ 
    required String market,
    required String instrument,
    ...
    final _path = r'/spot/v1/historical/orderbook/l2/snapshot/minute';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'market': encodeQueryParameter(_serializers, market, const FullType(String)),
      r'instrument': encodeQueryParameter(_serializers, instrument, const FullType(String)),
      r'minute_ts': encodeQueryParameter(_serializers, minuteTs, const FullType(int)),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SPOTINSTRUMENTTRADERESPONSE] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SPOTINSTRUMENTTRADERESPONSE>> spotV1HistoricalTrades({ 
    required String market,
    required String instrument,
    int? afterTs,
    int? lastCcseq = 0,
    ...
    final _path = r'/spot/v1/historical/trades';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SPOTINSTRUMENTTRADERESPONSE _responseData;

    try {
      const _responseType = FullType(SPOTINSTRUMENTTRADERESPONSE);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<SPOTINSTRUMENTTRADERESPONSE>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [SPOTINSTRUMENTTRADERESPONSE] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SPOTINSTRUMENTTRADERESPONSE>> spotV1HistoricalTradesHour({ 
    required String market,
    required String instrument,
    int? hourTs,
    String? mappingPriority = 'CHECK_MAPPED_FIRST',
    ...
    final _path = r'/spot/v1/historical/trades/hour';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SPOTINSTRUMENTMETADATARESPONSE] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SPOTINSTRUMENTMETADATARESPONSE>> spotV1LatestInstrumentMetadata({ 
    required String market,
    ...
    final _path = r'/spot/v1/latest/instrument/metadata';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SPOTINSTRUMENTMETADATARESPONSE _responseData;

    try {
      const _responseType = FullType(SPOTINSTRUMENTMETADATARESPONSE);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<SPOTINSTRUMENTMETADATARESPONSE>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SPOTINSTRUMENTMARKETDATARESPONSE] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SPOTINSTRUMENTMARKETDATARESPONSE>> spotV1LatestTick({ 
    required String market,
    required BuiltList<String> instruments,
    BuiltList<String>? groups,
    String? mappingPriority = 'CHECK_MAPPED_FIRST',
    ...
    final _path = r'/spot/v1/latest/tick';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SPOTINSTRUMENTMARKETDATARESPONSE _responseData;

    try {
      const _responseType = FullType(SPOTINSTRUMENTMARKETDATARESPONSE);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<SPOTINSTRUMENTMARKETDATARESPONSE>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GENERICRESPONSE] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GENERICRESPONSE>> spotV1Markets({ 
    String? market = '',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [GENERICRESPONSE] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GENERICRESPONSE>> spotV1MarketsInstruments({ 
    String? market = '',
    String? instrument = '',
    ...
    final _path = r'/spot/v1/markets/instruments';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [GENERICRESPONSE] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GENERICRESPONSE>> spotV1MarketsInstrumentsUnmapped({ 
    String? market = '',
    String? instrument = '',
    BuiltList<String>? instrumentStatus,
    CancelToken? cancelToken,
    ...
    final _path = r'/spot/v1/markets/instruments/unmapped';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
