...
#' @docType class
#' @title ErrorErr
#' @description ErrorErr Class
#' @format An \code{R6Class} generator object
#' @field message A message describing the error character [optional]
#' @field other_info  \link{ErrorErrOtherInfo} [optional]
...
ErrorErr <- R6::R6Class(
  ...
  public = list(
    ...
    `other_info` = NULL,
    `type` = NULL,
    #' Initialize a new ErrorErr class.
    #'
    #' @description
    #' Initialize a new ErrorErr class.
    #'
    ...
    #' To JSON String
    #'
    #' @return ErrorErr in JSON format
    #' @export
    toJSON = function() {
      ErrorErrObject <- list()
      if (!is.null(self$`message`)) {
        ErrorErrObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`other_info`)) {
        ErrorErrObject[["other_info"]] <-
    ...
    #' Deserialize JSON string into an instance of ErrorErr
    #'
    #' @description
    #' Deserialize JSON string into an instance of ErrorErr
    #'
    #' @param input_json the JSON input
    #' @return the instance of ErrorErr
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`other_info`)) {
        other_info_object <- ErrorErrOtherInfo$new()
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`message` <- this_object$`message`
      self$`other_info` <- ErrorErrOtherInfo$new()$fromJSON(jsonlite::toJSON(this_object$other_info, auto_unbox = TRUE, digits = NA))
      self$`type` <- this_object$`type`
      self
    },
    #' Validate JSON input with respect to ErrorErr
    #'
    #' @description
    #' Validate JSON input with respect to ErrorErr and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ErrorErr
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# ErrorErr$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
