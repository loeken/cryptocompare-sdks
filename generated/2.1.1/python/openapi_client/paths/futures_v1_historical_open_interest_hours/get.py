...
class BaseApi(api_client.Api):
    @typing.overload
    def _futures_v1_historical_open_interest_hours_oapg(
        self,
...
class FuturesV1HistoricalOpenInterestHours(BaseApi):
    ...
    def futures_v1_historical_open_interest_hours(
        ...
        return self._futures_v1_historical_open_interest_hours_oapg(
