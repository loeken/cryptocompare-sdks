...
class BaseApi(api_client.Api):
    @typing.overload
    def _futures_v1_historical_open_interest_days_oapg(
        self,
...
class FuturesV1HistoricalOpenInterestDays(BaseApi):
    ...
    def futures_v1_historical_open_interest_days(
        ...
        return self._futures_v1_historical_open_interest_days_oapg(
