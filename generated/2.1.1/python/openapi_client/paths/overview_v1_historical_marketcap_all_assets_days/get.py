...
class BaseApi(api_client.Api):
    @typing.overload
    def _overview_v1_historical_marketcap_all_assets_days_oapg(
        self,
...
class OverviewV1HistoricalMarketcapAllAssetsDays(BaseApi):
    ...
    def overview_v1_historical_marketcap_all_assets_days(
        ...
        return self._overview_v1_historical_marketcap_all_assets_days_oapg(
