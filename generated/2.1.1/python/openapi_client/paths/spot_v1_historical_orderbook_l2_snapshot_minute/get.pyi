...
class InstrumentSchema(
    ...
    pass
MinuteTsSchema = schemas.IntSchema
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'minute_ts': typing.Union[MinuteTsSchema, decimal.Decimal, int, ],
    }
)
...
request_query_minute_ts = api_client.QueryParameter(
    name="minute_ts",
    style=api_client.ParameterStyle.FORM,
    schema=MinuteTsSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _spot_v1_historical_orderbook_l2_snapshot_minute_oapg(
        self,
...
class SpotV1HistoricalOrderbookL2SnapshotMinute(BaseApi):
    ...
    def spot_v1_historical_orderbook_l2_snapshot_minute(
        ...
        return self._spot_v1_historical_orderbook_l2_snapshot_minute_oapg(
