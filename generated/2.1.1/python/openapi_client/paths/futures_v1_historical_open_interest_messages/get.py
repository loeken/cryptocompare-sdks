...
class BaseApi(api_client.Api):
    @typing.overload
    def _futures_v1_historical_open_interest_messages_oapg(
        self,
...
class FuturesV1HistoricalOpenInterestMessages(BaseApi):
    ...
    def futures_v1_historical_open_interest_messages(
        ...
        return self._futures_v1_historical_open_interest_messages_oapg(
