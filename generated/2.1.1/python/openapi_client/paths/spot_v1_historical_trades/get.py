...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'after_ts': typing.Union[AfterTsSchema, decimal.Decimal, int, ],
        'last_ccseq': typing.Union[LastCcseqSchema, decimal.Decimal, int, ],
...
request_query_after_ts = api_client.QueryParameter(
    name="after_ts",
    style=api_client.ParameterStyle.FORM,
    schema=AfterTsSchema,
)
request_query_last_ccseq = api_client.QueryParameter(
    name="last_ccseq",
    style=api_client.ParameterStyle.FORM,
    schema=LastCcseqSchema,
)
...
SchemaFor200ResponseBodyApplicationJson = SPOTINSTRUMENTTRADERESPONSE
...
class BaseApi(api_client.Api):
    @typing.overload
    def _spot_v1_historical_trades_oapg(
        self,
    ...
    def _spot_v1_historical_trades_oapg(
        ...
        for parameter in (
            ...
            request_query_after_ts,
            request_query_last_ccseq,
            request_query_limit,
...
class SpotV1HistoricalTrades(BaseApi):
    ...
    def spot_v1_historical_trades(
        ...
        return self._spot_v1_historical_trades_oapg(
