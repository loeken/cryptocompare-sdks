...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'asset_type': typing.Union[AssetTypeSchema, str, ],
...
class AssetV1TopList(BaseApi):
    ...
    def asset_v1_top_list(
        ...
        return self._asset_v1_top_list_oapg(
