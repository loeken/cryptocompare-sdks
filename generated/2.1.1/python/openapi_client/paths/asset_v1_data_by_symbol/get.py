...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'asset_symbol': typing.Union[AssetSymbolSchema, str, ],
    }
)
...
request_query_asset_symbol = api_client.QueryParameter(
    name="asset_symbol",
    style=api_client.ParameterStyle.FORM,
    schema=AssetSymbolSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _asset_v1_data_by_symbol_oapg(
        self,
...
class AssetV1DataBySymbol(BaseApi):
    ...
    def asset_v1_data_by_symbol(
        ...
        return self._asset_v1_data_by_symbol_oapg(
