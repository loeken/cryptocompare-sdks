...
SchemaFor200ResponseBodyApplicationJson = SPOTINSTRUMENTMARKETDATARESPONSE
...
class SpotV1LatestTick(BaseApi):
    ...
    def spot_v1_latest_tick(
        ...
        return self._spot_v1_latest_tick_oapg(
