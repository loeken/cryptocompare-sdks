...
class BaseApi(api_client.Api):
    @typing.overload
    def _futures_v1_historical_open_interest_minutes_oapg(
        self,
...
class FuturesV1HistoricalOpenInterestMinutes(BaseApi):
    ...
    def futures_v1_historical_open_interest_minutes(
        ...
        return self._futures_v1_historical_open_interest_minutes_oapg(
