...
SchemaFor200ResponseBodyApplicationJson = SPOTINSTRUMENTHISTODATARESPONSE
...
class BaseApi(api_client.Api):
    @typing.overload
    def _spot_v1_historical_minutes_oapg(
        self,
...
class SpotV1HistoricalMinutes(BaseApi):
    ...
    def spot_v1_historical_minutes(
        ...
        return self._spot_v1_historical_minutes_oapg(
