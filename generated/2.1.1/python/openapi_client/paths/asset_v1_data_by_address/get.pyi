...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'chain_symbol': typing.Union[ChainSymbolSchema, str, ],
    }
)
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        'groups': typing.Union[GroupsSchema, str, ],
    },
    total=False
)
...
request_query_chain_symbol = api_client.QueryParameter(
    name="chain_symbol",
    style=api_client.ParameterStyle.FORM,
    schema=ChainSymbolSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _asset_v1_data_by_address_oapg(
        self,
...
class AssetV1DataByAddress(BaseApi):
    ...
    def asset_v1_data_by_address(
        ...
        return self._asset_v1_data_by_address_oapg(
