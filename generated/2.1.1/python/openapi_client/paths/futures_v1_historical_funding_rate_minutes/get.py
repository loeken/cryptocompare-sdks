...
class BaseApi(api_client.Api):
    @typing.overload
    def _futures_v1_historical_funding_rate_minutes_oapg(
        self,
...
class FuturesV1HistoricalFundingRateMinutes(BaseApi):
    ...
    def futures_v1_historical_funding_rate_minutes(
        ...
        return self._futures_v1_historical_funding_rate_minutes_oapg(
