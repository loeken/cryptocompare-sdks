...
class BaseApi(api_client.Api):
    @typing.overload
    def _futures_v1_historical_funding_rate_messages_hour_oapg(
        self,
...
class FuturesV1HistoricalFundingRateMessagesHour(BaseApi):
    ...
    def futures_v1_historical_funding_rate_messages_hour(
        ...
        return self._futures_v1_historical_funding_rate_messages_hour_oapg(
