...
SchemaFor200ResponseBodyApplicationJson = SPOTINSTRUMENTMETADATARESPONSE
...
class BaseApi(api_client.Api):
    @typing.overload
    def _spot_v1_latest_instrument_metadata_oapg(
        self,
...
class SpotV1LatestInstrumentMetadata(BaseApi):
    ...
    def spot_v1_latest_instrument_metadata(
        ...
        return self._spot_v1_latest_instrument_metadata_oapg(
