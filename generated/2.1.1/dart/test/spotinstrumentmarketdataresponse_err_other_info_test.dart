...
// tests for SPOTINSTRUMENTMARKETDATARESPONSEErrOtherInfo
void main() {
  // final instance = SPOTINSTRUMENTMARKETDATARESPONSEErrOtherInfo();

  group('test SPOTINSTRUMENTMARKETDATARESPONSEErrOtherInfo', () {
