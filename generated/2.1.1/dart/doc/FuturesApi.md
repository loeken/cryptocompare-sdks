...
try {
    final result = api_instance.futuresV1HistoricalTrades(market, instrument, afterTs, lastCcseq, limit, mappingPriority, responseFormat, return404OnEmptyResponse);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.indexV1HistoricalMinutes(market, instrument, groups, limit, toTs, aggregate, fill, mappingPriority, responseFormat);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.indexV1LatestInstrumentMetadata(market, instruments, groups, mappingPriority);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.indexV1LatestTick(market, instruments, groups, mappingPriority);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.indexV1Markets(market);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.indexV1MarketsInstruments(market, instrument, instrumentStatus);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.indexV1MarketsInstrumentsUnmapped(market, instrument, instrumentStatus);
    print(result);
} catch (e) {
