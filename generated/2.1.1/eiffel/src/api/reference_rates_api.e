...
feature -- API Access
	...
	index_cc_v1_historical_days (market: STRING_32; instrument: STRING_32; groups: detachable LIST [STRING_32]; limit: INTEGER_32; to_ts: INTEGER_32; aggregate: INTEGER_32; fill: BOOLEAN; mapping_priority: STRING_32; response_format: STRING_32): detachable GENERIC_RESPONSE
			-- 
			-- 
			-- 
		...
		do
			...
			l_path := "/index/cc/v1/historical/days"
	...
	index_cc_v1_historical_hours (market: STRING_32; instrument: STRING_32; groups: detachable LIST [STRING_32]; limit: INTEGER_32; to_ts: INTEGER_32; aggregate: INTEGER_32; fill: BOOLEAN; mapping_priority: STRING_32; response_format: STRING_32): detachable GENERIC_RESPONSE
			-- 
			-- 
			-- 
			-- argument: market The exchange to obtain data from (required)
		...
		do
			...
			l_path := "/index/cc/v1/historical/hours"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "market", market));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "instrument", instrument));
			l_request.fill_query_params(api_client.parameter_to_tuple("csv", "groups", groups));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "limit", limit));
	...
	index_cc_v1_historical_messages (market: STRING_32; instrument: STRING_32; after_ts: INTEGER_32; last_ccseq: INTEGER_32; mapping_priority: STRING_32; limit: INTEGER_32; response_format: STRING_32; return_404_on_empty_response: BOOLEAN): detachable GENERIC_RESPONSE
			-- 
			-- 
			-- 
			-- argument: market The exchange to obtain data from (required)
		...
		do
			...
			l_path := "/index/cc/v1/historical/messages"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "market", market));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "instrument", instrument));
	...
	index_cc_v1_historical_messages_hour (market: STRING_32; instrument: STRING_32; hour_ts: INTEGER_32; mapping_priority: STRING_32; response_format: STRING_32; return_404_on_empty_response: BOOLEAN): detachable GENERIC_RESPONSE
			-- 
			-- 
			-- 
			-- argument: market The exchange to obtain data from (required)
		...
		do
			...
			l_path := "/index/cc/v1/historical/messages/hour"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "market", market));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "instrument", instrument));
	...
	index_cc_v1_historical_minutes (market: STRING_32; instrument: STRING_32; groups: detachable LIST [STRING_32]; limit: INTEGER_32; to_ts: INTEGER_32; aggregate: INTEGER_32; fill: BOOLEAN; mapping_priority: STRING_32; response_format: STRING_32): detachable GENERIC_RESPONSE
			-- 
			-- 
			-- 
			-- argument: market The exchange to obtain data from (required)
		...
		do
			...
			l_path := "/index/cc/v1/historical/minutes"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "market", market));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "instrument", instrument));
			l_request.fill_query_params(api_client.parameter_to_tuple("csv", "groups", groups));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "limit", limit));
	...
	index_cc_v1_latest_instrument_metadata (market: STRING_32; instruments: LIST [STRING_32]; groups: detachable LIST [STRING_32]; mapping_priority: STRING_32): detachable GENERIC_RESPONSE
			-- 
			-- 
			-- 
			-- argument: market The exchange to obtain data from (required)
		...
		do
			...
			l_path := "/index/cc/v1/latest/instrument/metadata"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "market", market));
	...
	index_cc_v1_latest_tick (market: STRING_32; instruments: LIST [STRING_32]; groups: detachable LIST [STRING_32]; mapping_priority: STRING_32): detachable GENERIC_RESPONSE
			-- 
			-- 
			-- 
			-- argument: market The exchange to obtain data from (required)
		...
		do
			...
			l_path := "/index/cc/v1/latest/tick"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "market", market));
			l_request.fill_query_params(api_client.parameter_to_tuple("csv", "instruments", instruments));
			l_request.fill_query_params(api_client.parameter_to_tuple("csv", "groups", groups));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "mapping_priority", mapping_priority));
	...
	index_cc_v1_markets (market: STRING_32): detachable GENERIC_RESPONSE
			-- 
			-- 
			-- 
	...
	index_cc_v1_markets_instruments (market: STRING_32; instrument: STRING_32; instrument_status: detachable LIST [STRING_32]): detachable GENERIC_RESPONSE
			-- 
			-- 
			-- 
			-- argument: market The exchange to obtain data from (optional, default to )
		...
		do
			...
			l_path := "/index/cc/v1/markets/instruments"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "market", market));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "instrument", instrument));
	...
	index_cc_v1_markets_instruments_unmapped (market: STRING_32; instrument: STRING_32; instrument_status: detachable LIST [STRING_32]): detachable GENERIC_RESPONSE
			-- 
			-- 
			-- 
			-- argument: market The exchange to obtain data from (optional, default to )
		...
		do
			...
			l_path := "/index/cc/v1/markets/instruments/unmapped"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "market", market));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "instrument", instrument));
			l_request.fill_query_params(api_client.parameter_to_tuple("csv", "instrument_status", instrument_status));
