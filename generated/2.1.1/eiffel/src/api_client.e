...
feature {NONE} -- Initialization
	...
	make
		do
			...
			authentications.force (create {API_KEY_AUTH}.make ("header", "authorization"), "api_key_header")
			is_api_key_configured := True 
			authentications.force (create {API_KEY_AUTH}.make ("query", "api_key"), "api_key_query")
			is_api_key_configured := True 
		end

feature -- Access

	default_base_path: STRING = "https://data-api.cryptocompare.com"
			-- default base path.
