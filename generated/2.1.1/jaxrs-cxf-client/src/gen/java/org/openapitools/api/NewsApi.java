...
public interface NewsApi  {
    ...
    public GENERICRESPONSE newsV1ArticleList(@QueryParam("source_ids") List<String> sourceIds, @QueryParam("lang") @DefaultValue("EN")String lang, @QueryParam("categories") List<String> categories, @QueryParam("exclude_categories") List<String> excludeCategories, @QueryParam("to_ts") @DefaultValue("-1")Integer toTs);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 502, message = "The 502 error occurs when our API is not running. This error is returned by our proxy / load balancer.", response = Error.class),
        @ApiResponse(code = 503, message = "The 503 error occurs when there is an issue with one of our data sources and we can't even return a partial answer.", response = Error.class) })
    public GENERICRESPONSE newsV1SourceList(@QueryParam("lang") @DefaultValue("EN")String lang, @QueryParam("type") @DefaultValue("RSS")String type, @QueryParam("status") @DefaultValue("ACTIVE")String status);
}
