...
/**
 * Check if a given object implements the SPOTINSTRUMENTTRADE interface.
 */
export function instanceOfSPOTINSTRUMENTTRADE(value: object): boolean {
    let isInstance = true;
...
export function SPOTINSTRUMENTTRADEFromJSON(json: any): SPOTINSTRUMENTTRADE {
    return SPOTINSTRUMENTTRADEFromJSONTyped(json, false);
}

export function SPOTINSTRUMENTTRADEFromJSONTyped(json: any, ignoreDiscriminator: boolean): SPOTINSTRUMENTTRADE {
...
export function SPOTINSTRUMENTTRADEToJSON(value?: SPOTINSTRUMENTTRADE | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
