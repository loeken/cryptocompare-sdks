...
/**
 * Check if a given object implements the SPOTINSTRUMENTHISTODATA interface.
 */
export function instanceOfSPOTINSTRUMENTHISTODATA(value: object): boolean {
    let isInstance = true;
...
export function SPOTINSTRUMENTHISTODATAFromJSON(json: any): SPOTINSTRUMENTHISTODATA {
    return SPOTINSTRUMENTHISTODATAFromJSONTyped(json, false);
}

export function SPOTINSTRUMENTHISTODATAFromJSONTyped(json: any, ignoreDiscriminator: boolean): SPOTINSTRUMENTHISTODATA {
...
export function SPOTINSTRUMENTHISTODATAToJSON(value?: SPOTINSTRUMENTHISTODATA | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
