...
@interface OAISpotApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAISpotApi

NSString* kOAISpotApiErrorDomain = @"OAISpotApiErrorDomain";
NSInteger kOAISpotApiMissingParamErrorCode = 234513;
...
///
///  @returns OAISPOTINSTRUMENTHISTODATARESPONSE*
///
-(NSURLSessionTask*) spotV1HistoricalDaysWithMarket: (NSString*) market
    ...
    if (market == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAISpotApiErrorDomain code:kOAISpotApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/spot/v1/historical/days"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAISPOTINSTRUMENTHISTODATARESPONSE*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAISPOTINSTRUMENTHISTODATARESPONSE*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) spotV1HistoricalHoursWithMarket: (NSString*) market
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/spot/v1/historical/hours"];
...
-(NSURLSessionTask*) spotV1HistoricalMinutesWithMarket: (NSString*) market
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/spot/v1/historical/minutes"];
...
-(NSURLSessionTask*) spotV1HistoricalOrderbookL2SnapshotMinuteWithMarket: (NSString*) market
    ...
    if (minuteTs == nil) {
        NSParameterAssert(minuteTs);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"minuteTs"] };
            NSError* error = [NSError errorWithDomain:kOAISpotApiErrorDomain code:kOAISpotApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/spot/v1/historical/orderbook/l2/snapshot/minute"];
    ...
    if (minuteTs != nil) {
        queryParams[@"minute_ts"] = minuteTs;
    }
    if (depth != nil) {
...
///
///  @returns OAISPOTINSTRUMENTTRADERESPONSE*
///
-(NSURLSessionTask*) spotV1HistoricalTradesWithMarket: (NSString*) market
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/spot/v1/historical/trades"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAISPOTINSTRUMENTTRADERESPONSE*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAISPOTINSTRUMENTTRADERESPONSE*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) spotV1HistoricalTradesHourWithMarket: (NSString*) market
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/spot/v1/historical/trades/hour"];
...
///  @param mappingPriority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST (optional, default to @"CHECK_MAPPED_FIRST")
///
///  @returns OAISPOTINSTRUMENTMETADATARESPONSE*
///
-(NSURLSessionTask*) spotV1LatestInstrumentMetadataWithMarket: (NSString*) market
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/spot/v1/latest/instrument/metadata"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAISPOTINSTRUMENTMETADATARESPONSE*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAISPOTINSTRUMENTMETADATARESPONSE*)data, error);
                                }
                            }];
}
...
///  @param mappingPriority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST (optional, default to @"CHECK_MAPPED_FIRST")
///
///  @returns OAISPOTINSTRUMENTMARKETDATARESPONSE*
///
-(NSURLSessionTask*) spotV1LatestTickWithMarket: (NSString*) market
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/spot/v1/latest/tick"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAISPOTINSTRUMENTMARKETDATARESPONSE*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAISPOTINSTRUMENTMARKETDATARESPONSE*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) spotV1MarketsWithMarket: (NSString*) market
    completionHandler: (void (^)(OAIGENERICRESPONSE* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/spot/v1/markets"];
...
-(NSURLSessionTask*) spotV1MarketsInstrumentsWithMarket: (NSString*) market
    ...
    completionHandler: (void (^)(OAIGENERICRESPONSE* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/spot/v1/markets/instruments"];
...
-(NSURLSessionTask*) spotV1MarketsInstrumentsUnmappedWithMarket: (NSString*) market
    ...
    instrumentStatus: (NSArray<NSString*>*) instrumentStatus
    completionHandler: (void (^)(OAIGENERICRESPONSE* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/spot/v1/markets/instruments/unmapped"];
