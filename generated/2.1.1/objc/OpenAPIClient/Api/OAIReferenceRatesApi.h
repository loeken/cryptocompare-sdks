...
@interface OAIReferenceRatesApi: NSObject <OAIApi>

extern NSString* kOAIReferenceRatesApiErrorDomain;
extern NSInteger kOAIReferenceRatesApiMissingParamErrorCode;
