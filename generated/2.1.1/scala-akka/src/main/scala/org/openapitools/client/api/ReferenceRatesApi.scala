...
class ReferenceRatesApi(baseUrl: String) {
   ...
   */
  def indexCcV1HistoricalDays(market: String, instrument: String, groups: Seq[String], limit: Option[Int] = None, toTs: Option[Int] = None, aggregate: Option[Int] = None, fill: Option[Boolean] = None, mappingPriority: Option[String] = None, responseFormat: Option[String] = None): ApiRequest[GENERICRESPONSE] =
    ApiRequest[GENERICRESPONSE](ApiMethods.GET, baseUrl, "/index/cc/v1/historical/days", "application/json")
   ...
   * @param responseFormat The format of the data response in uppercase. It can be one of the following: JSON,CSV
   */
  def indexCcV1HistoricalHours(market: String, instrument: String, groups: Seq[String], limit: Option[Int] = None, toTs: Option[Int] = None, aggregate: Option[Int] = None, fill: Option[Boolean] = None, mappingPriority: Option[String] = None, responseFormat: Option[String] = None): ApiRequest[GENERICRESPONSE] =
    ApiRequest[GENERICRESPONSE](ApiMethods.GET, baseUrl, "/index/cc/v1/historical/hours", "application/json")
      .withQueryParam("market", market)
      .withQueryParam("instrument", instrument)
      .withQueryParam("groups", ArrayValues(groups, CSV))
      .withQueryParam("limit", limit)
   ...
   */
  def indexCcV1HistoricalMessages(market: String, instrument: String, afterTs: Option[Int] = None, lastCcseq: Option[Int] = None, mappingPriority: Option[String] = None, limit: Option[Int] = None, responseFormat: Option[String] = None, return404OnEmptyResponse: Option[Boolean] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[GENERICRESPONSE] =
    ApiRequest[GENERICRESPONSE](ApiMethods.GET, baseUrl, "/index/cc/v1/historical/messages", "application/json")
   ...
   * @param return404OnEmptyResponse If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats.
   */
  def indexCcV1HistoricalMessagesHour(market: String, instrument: String, hourTs: Option[Int] = None, mappingPriority: Option[String] = None, responseFormat: Option[String] = None, return404OnEmptyResponse: Option[Boolean] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[GENERICRESPONSE] =
    ApiRequest[GENERICRESPONSE](ApiMethods.GET, baseUrl, "/index/cc/v1/historical/messages/hour", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withApiKey(apiKey, "api_key", QUERY)
      .withQueryParam("market", market)
      .withQueryParam("instrument", instrument)
   ...
   * @param responseFormat The format of the data response in uppercase. It can be one of the following: JSON,CSV
   */
  def indexCcV1HistoricalMinutes(market: String, instrument: String, groups: Seq[String], limit: Option[Int] = None, toTs: Option[Int] = None, aggregate: Option[Int] = None, fill: Option[Boolean] = None, mappingPriority: Option[String] = None, responseFormat: Option[String] = None): ApiRequest[GENERICRESPONSE] =
    ApiRequest[GENERICRESPONSE](ApiMethods.GET, baseUrl, "/index/cc/v1/historical/minutes", "application/json")
      .withQueryParam("market", market)
      .withQueryParam("instrument", instrument)
      .withQueryParam("groups", ArrayValues(groups, CSV))
      .withQueryParam("limit", limit)
   ...
   * @param mappingPriority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST
   */
  def indexCcV1LatestInstrumentMetadata(market: String, instruments: Seq[String], groups: Seq[String], mappingPriority: Option[String] = None): ApiRequest[GENERICRESPONSE] =
    ApiRequest[GENERICRESPONSE](ApiMethods.GET, baseUrl, "/index/cc/v1/latest/instrument/metadata", "application/json")
      .withQueryParam("market", market)
   ...
   * @param mappingPriority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST
   */
  def indexCcV1LatestTick(market: String, instruments: Seq[String], groups: Seq[String], mappingPriority: Option[String] = None): ApiRequest[GENERICRESPONSE] =
    ApiRequest[GENERICRESPONSE](ApiMethods.GET, baseUrl, "/index/cc/v1/latest/tick", "application/json")
      .withQueryParam("market", market)
      .withQueryParam("instruments", ArrayValues(instruments, CSV))
      .withQueryParam("groups", ArrayValues(groups, CSV))
      .withQueryParam("mapping_priority", mappingPriority)
   ...
   * @param market The exchange to obtain data from
   */
  def indexCcV1Markets(market: Option[String] = None): ApiRequest[GENERICRESPONSE] =
    ApiRequest[GENERICRESPONSE](ApiMethods.GET, baseUrl, "/index/cc/v1/markets", "application/json")
      .withQueryParam("market", market)
      .withSuccessResponse[GENERICRESPONSE](200)
      .withErrorResponse[Error](400)
      .withErrorResponse[Error](401)
   ...
   */
  def indexCcV1MarketsInstruments(market: Option[String] = None, instrument: Option[String] = None, instrumentStatus: Seq[String]): ApiRequest[GENERICRESPONSE] =
    ApiRequest[GENERICRESPONSE](ApiMethods.GET, baseUrl, "/index/cc/v1/markets/instruments", "application/json")
      .withQueryParam("market", market)
      .withQueryParam("instrument", instrument)
   ...
   * @param instrumentStatus The status of the instrument, can be one of the following: ACTIVE, IGNORED, RETIRED, EXPIRED
   */
  def indexCcV1MarketsInstrumentsUnmapped(market: Option[String] = None, instrument: Option[String] = None, instrumentStatus: Seq[String]): ApiRequest[GENERICRESPONSE] =
    ApiRequest[GENERICRESPONSE](ApiMethods.GET, baseUrl, "/index/cc/v1/markets/instruments/unmapped", "application/json")
      .withQueryParam("market", market)
      .withQueryParam("instrument", instrument)
      .withQueryParam("instrument_status", ArrayValues(instrumentStatus, CSV))
      .withSuccessResponse[GENERICRESPONSE](200)
