...
case class SPOTINSTRUMENTHISTODATA (
  ...
  FIRST_TRADE_PRICE: Option[Integer] = None,
  ...
  FIRST_TRADE_TIMESTAMP: Option[Integer] = None,
  ...
  HIGH_TRADE_PRICE: Option[Integer] = None,
  ...
  HIGH_TRADE_TIMESTAMP: Option[Integer] = None,
  ...
  LAST_TRADE_PRICE: Option[Integer] = None,
  ...
  LAST_TRADE_TIMESTAMP: Option[Integer] = None,
  ...
  LOW_TRADE_PRICE: Option[Integer] = None,
  ...
  LOW_TRADE_TIMESTAMP: Option[Integer] = None,
  ...
  TOTAL_TRADES_UNKNOWN: Option[Integer] = None,
