...
**last_trade_spot_from_blob** | **{str: (bool, date, datetime, dict, float, int, list, str, none_type)}** | This is the last TRADE_SPOT that we have seen on the specific source type in internal format. | [optional] 
