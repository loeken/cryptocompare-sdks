...
**LAST_TRADE_SPOT_FROM_STREAMING_EXTERNAL** | [**AnyCodable**](.md) | This is the last TRADE_SPOT that we have seen on the specific trade source in external format. | [optional] 
