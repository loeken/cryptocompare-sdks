...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoCompareMarketIndexReferenceDataNewsAndOverviewMetrcisApiForTheCryptocurrencyIndustry.GENERICRESPONSE();
  });
  ...
  describe('GENERICRESPONSE', function() {
    it('should create an instance of GENERICRESPONSE', function() {
      ...
      //var instance = new CryptoCompareMarketIndexReferenceDataNewsAndOverviewMetrcisApiForTheCryptocurrencyIndustry.GENERICRESPONSE();
      //expect(instance).to.be.a(CryptoCompareMarketIndexReferenceDataNewsAndOverviewMetrcisApiForTheCryptocurrencyIndustry.GENERICRESPONSE);
    });
