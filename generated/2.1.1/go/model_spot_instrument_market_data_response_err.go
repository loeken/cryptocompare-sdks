...
// checks if the SPOTINSTRUMENTMARKETDATARESPONSEErr type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SPOTINSTRUMENTMARKETDATARESPONSEErr{}

// SPOTINSTRUMENTMARKETDATARESPONSEErr struct for SPOTINSTRUMENTMARKETDATARESPONSEErr
type SPOTINSTRUMENTMARKETDATARESPONSEErr struct {
	// A message describing the error
	Message *string `json:"message,omitempty"`
	OtherInfo *SPOTINSTRUMENTMARKETDATARESPONSEErrOtherInfo `json:"other_info,omitempty"`
...
func NewSPOTINSTRUMENTMARKETDATARESPONSEErr() *SPOTINSTRUMENTMARKETDATARESPONSEErr {
	this := SPOTINSTRUMENTMARKETDATARESPONSEErr{}
	return &this
}
...
func (o *SPOTINSTRUMENTMARKETDATARESPONSEErr) GetOtherInfo() SPOTINSTRUMENTMARKETDATARESPONSEErrOtherInfo {
	if o == nil || isNil(o.OtherInfo) {
		var ret SPOTINSTRUMENTMARKETDATARESPONSEErrOtherInfo
		return ret
	}
	return *o.OtherInfo
}
...
// SetOtherInfo gets a reference to the given SPOTINSTRUMENTMARKETDATARESPONSEErrOtherInfo and assigns it to the OtherInfo field.
...
func (o SPOTINSTRUMENTMARKETDATARESPONSEErr) MarshalJSON() ([]byte, error) {
...
func (o SPOTINSTRUMENTMARKETDATARESPONSEErr) ToMap() (map[string]interface{}, error) {
...
type NullableSPOTINSTRUMENTMARKETDATARESPONSEErr struct {
	value *SPOTINSTRUMENTMARKETDATARESPONSEErr
	isSet bool
}

func (v NullableSPOTINSTRUMENTMARKETDATARESPONSEErr) Get() *SPOTINSTRUMENTMARKETDATARESPONSEErr {
	return v.value
}

func (v *NullableSPOTINSTRUMENTMARKETDATARESPONSEErr) Set(val *SPOTINSTRUMENTMARKETDATARESPONSEErr) {
	v.value = val
	v.isSet = true
}

func (v NullableSPOTINSTRUMENTMARKETDATARESPONSEErr) IsSet() bool {
	return v.isSet
}

func (v *NullableSPOTINSTRUMENTMARKETDATARESPONSEErr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSPOTINSTRUMENTMARKETDATARESPONSEErr(val *SPOTINSTRUMENTMARKETDATARESPONSEErr) *NullableSPOTINSTRUMENTMARKETDATARESPONSEErr {
	return &NullableSPOTINSTRUMENTMARKETDATARESPONSEErr{value: val, isSet: true}
}

func (v NullableSPOTINSTRUMENTMARKETDATARESPONSEErr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSPOTINSTRUMENTMARKETDATARESPONSEErr) UnmarshalJSON(src []byte) error {
	v.isSet = true
