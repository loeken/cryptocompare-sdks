...
// checks if the ErrorErrOtherInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorErrOtherInfo{}

// ErrorErrOtherInfo struct for ErrorErrOtherInfo
type ErrorErrOtherInfo struct {
...
func (o ErrorErrOtherInfo) MarshalJSON() ([]byte, error) {
...
func (o ErrorErrOtherInfo) ToMap() (map[string]interface{}, error) {
...
type NullableErrorErrOtherInfo struct {
	value *ErrorErrOtherInfo
	isSet bool
}

func (v NullableErrorErrOtherInfo) Get() *ErrorErrOtherInfo {
	return v.value
}

func (v *NullableErrorErrOtherInfo) Set(val *ErrorErrOtherInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorErrOtherInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorErrOtherInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorErrOtherInfo(val *ErrorErrOtherInfo) *NullableErrorErrOtherInfo {
	return &NullableErrorErrOtherInfo{value: val, isSet: true}
}

func (v NullableErrorErrOtherInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorErrOtherInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
