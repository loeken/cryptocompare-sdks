...
class OverviewApi(baseUrl: String) {
   ...
   */
  def overviewV1HistoricalMarketcapAllAssetsDays(groups: Seq[String], limit: Option[Int] = None, toTs: Option[Int] = None, aggregate: Option[Int] = None, fill: Option[Boolean] = None, responseFormat: Option[String] = None
): Request[Either[ResponseException[String, Exception], GENERICRESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/overview/v1/historical/marketcap/all/assets/days?groups=${ groups }&limit=${ limit }&to_ts=${ toTs }&aggregate=${ aggregate }&fill=${ fill }&response_format=${ responseFormat }")
   ...
   * @param responseFormat The format of the data response in uppercase. It can be one of the following: JSON,CSV
   */
  def overviewV1HistoricalMarketcapAllAssetsHours(groups: Seq[String], limit: Option[Int] = None, toTs: Option[Int] = None, aggregate: Option[Int] = None, fill: Option[Boolean] = None, responseFormat: Option[String] = None
): Request[Either[ResponseException[String, Exception], GENERICRESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/overview/v1/historical/marketcap/all/assets/hours?groups=${ groups }&limit=${ limit }&to_ts=${ toTs }&aggregate=${ aggregate }&fill=${ fill }&response_format=${ responseFormat }")
      .contentType("application/json")
      .response(asJson[GENERICRESPONSE])
   ...
   * @param responseFormat The format of the data response in uppercase. It can be one of the following: JSON,CSV
   */
  def overviewV1HistoricalMarketcapFtwAssetsDays(groups: Seq[String], limit: Option[Int] = None, toTs: Option[Int] = None, aggregate: Option[Int] = None, fill: Option[Boolean] = None, responseFormat: Option[String] = None
): Request[Either[ResponseException[String, Exception], GENERICRESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/overview/v1/historical/marketcap/ftw/assets/days?groups=${ groups }&limit=${ limit }&to_ts=${ toTs }&aggregate=${ aggregate }&fill=${ fill }&response_format=${ responseFormat }")
      .contentType("application/json")
      .response(asJson[GENERICRESPONSE])
   ...
   * @param responseFormat The format of the data response in uppercase. It can be one of the following: JSON,CSV
   */
  def overviewV1HistoricalMarketcapFtwAssetsHours(groups: Seq[String], limit: Option[Int] = None, toTs: Option[Int] = None, aggregate: Option[Int] = None, fill: Option[Boolean] = None, responseFormat: Option[String] = None
): Request[Either[ResponseException[String, Exception], GENERICRESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/overview/v1/historical/marketcap/ftw/assets/hours?groups=${ groups }&limit=${ limit }&to_ts=${ toTs }&aggregate=${ aggregate }&fill=${ fill }&response_format=${ responseFormat }")
      .contentType("application/json")
      .response(asJson[GENERICRESPONSE])
   ...
   */
  def overviewV1LatestMarketcapAllTick(groups: Seq[String]
): Request[Either[ResponseException[String, Exception], GENERICRESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/overview/v1/latest/marketcap/all/tick?groups=${ groups }")
      .contentType("application/json")
      .response(asJson[GENERICRESPONSE])
   ...
   */
  def overviewV1LatestMarketcapFtwTick(groups: Seq[String]
): Request[Either[ResponseException[String, Exception], GENERICRESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/overview/v1/latest/marketcap/ftw/tick?groups=${ groups }")
      .contentType("application/json")
      .response(asJson[GENERICRESPONSE])
