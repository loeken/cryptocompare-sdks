...
def apply(baseUrl: String = "https://data-api.cryptocompare.com") = new SpotApi(baseUrl)
}

class SpotApi(baseUrl: String) {

  /**
   * Expected answers:
   *   code 200 : SPOTINSTRUMENTHISTODATARESPONSE (Success response from the API.)
   ...
   */
  def spotV1HistoricalDays(market: String, instrument: String, groups: Seq[String], limit: Option[Int] = None, toTs: Option[Int] = None, aggregate: Option[Int] = None, fill: Option[Boolean] = None, mappingPriority: Option[String] = None, responseFormat: Option[String] = None
): Request[Either[ResponseException[String, Exception], SPOTINSTRUMENTHISTODATARESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/spot/v1/historical/days?market=${ market }&instrument=${ instrument }&groups=${ groups }&limit=${ limit }&to_ts=${ toTs }&aggregate=${ aggregate }&fill=${ fill }&mapping_priority=${ mappingPriority }&response_format=${ responseFormat }")
      .contentType("application/json")
      .response(asJson[SPOTINSTRUMENTHISTODATARESPONSE])
   ...
   * @param responseFormat The format of the data response in uppercase. It can be one of the following: JSON,CSV
   */
  def spotV1HistoricalHours(market: String, instrument: String, groups: Seq[String], limit: Option[Int] = None, toTs: Option[Int] = None, aggregate: Option[Int] = None, fill: Option[Boolean] = None, mappingPriority: Option[String] = None, responseFormat: Option[String] = None
): Request[Either[ResponseException[String, Exception], SPOTINSTRUMENTHISTODATARESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/spot/v1/historical/hours?market=${ market }&instrument=${ instrument }&groups=${ groups }&limit=${ limit }&to_ts=${ toTs }&aggregate=${ aggregate }&fill=${ fill }&mapping_priority=${ mappingPriority }&response_format=${ responseFormat }")
      .contentType("application/json")
      .response(asJson[SPOTINSTRUMENTHISTODATARESPONSE])
   ...
   * @param responseFormat The format of the data response in uppercase. It can be one of the following: JSON,CSV
   */
  def spotV1HistoricalMinutes(market: String, instrument: String, groups: Seq[String], limit: Option[Int] = None, toTs: Option[Int] = None, aggregate: Option[Int] = None, fill: Option[Boolean] = None, mappingPriority: Option[String] = None, responseFormat: Option[String] = None
): Request[Either[ResponseException[String, Exception], SPOTINSTRUMENTHISTODATARESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/spot/v1/historical/minutes?market=${ market }&instrument=${ instrument }&groups=${ groups }&limit=${ limit }&to_ts=${ toTs }&aggregate=${ aggregate }&fill=${ fill }&mapping_priority=${ mappingPriority }&response_format=${ responseFormat }")
      .contentType("application/json")
      .response(asJson[SPOTINSTRUMENTHISTODATARESPONSE])
   ...
   * @param responseFormat The format of the data response in uppercase. It can be one of the following: JSON,CSV
   */
  def spotV1HistoricalOrderbookL2SnapshotMinute(apiKey: String, apiKey: String)(market: String, instrument: String, minuteTs: Int, depth: Option[Int] = None, mappingPriority: Option[String] = None, responseFormat: Option[String] = None
): Request[Either[ResponseException[String, Exception], GENERICRESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/spot/v1/historical/orderbook/l2/snapshot/minute?market=${ market }&instrument=${ instrument }&minute_ts=${ minuteTs }&depth=${ depth }&mapping_priority=${ mappingPriority }&response_format=${ responseFormat }")
      .contentType("application/json")
  ...
  /**
   * Expected answers:
   *   code 200 : SPOTINSTRUMENTTRADERESPONSE (Success response from the API.)
   *   code 400 : Error (The 400 error occurs when some of the data sent is malformed.)
   *   code 401 : Error (The 401 error occurs when you don't use a valid API Key on an endpoint that requires authetication.)
   *   code 403 : Error (The 403 error occurs when you don't use a valid API Key on an endpoint that requires authetication.)
   *   code 404 : Error (The 404 error can either be returned when some/all of parameters sent are not found within our system. This could be beacuse parameters like market, instrument, news source, symbol, asset_id etc. are invalid)
   ...
   */
  def spotV1HistoricalTrades(apiKey: String, apiKey: String)(market: String, instrument: String, afterTs: Option[Int] = None, lastCcseq: Option[Int] = None, limit: Option[Int] = None, mappingPriority: Option[String] = None, responseFormat: Option[String] = None, return404OnEmptyResponse: Option[Boolean] = None
): Request[Either[ResponseException[String, Exception], SPOTINSTRUMENTTRADERESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/spot/v1/historical/trades?market=${ market }&instrument=${ instrument }&after_ts=${ afterTs }&last_ccseq=${ lastCcseq }&limit=${ limit }&mapping_priority=${ mappingPriority }&response_format=${ responseFormat }&return_404_on_empty_response=${ return404OnEmptyResponse }")
      .contentType("application/json")
      .header("authorization", apiKey)
      .response(asJson[SPOTINSTRUMENTTRADERESPONSE])
   ...
   * @param return404OnEmptyResponse If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats.
   */
  def spotV1HistoricalTradesHour(apiKey: String, apiKey: String)(market: String, instrument: String, hourTs: Option[Int] = None, mappingPriority: Option[String] = None, responseFormat: Option[String] = None, return404OnEmptyResponse: Option[Boolean] = None
): Request[Either[ResponseException[String, Exception], SPOTINSTRUMENTTRADERESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/spot/v1/historical/trades/hour?market=${ market }&instrument=${ instrument }&hour_ts=${ hourTs }&mapping_priority=${ mappingPriority }&response_format=${ responseFormat }&return_404_on_empty_response=${ return404OnEmptyResponse }")
      .contentType("application/json")
      .header("authorization", apiKey)
      .response(asJson[SPOTINSTRUMENTTRADERESPONSE])
  ...
  /**
   * Expected answers:
   *   code 200 : SPOTINSTRUMENTMETADATARESPONSE (Success response from the API.)
   *   code 400 : Error (The 400 error occurs when some of the data sent is malformed.)
   *   code 401 : Error (The 401 error occurs when you don't use a valid API Key on an endpoint that requires authetication.)
   *   code 403 : Error (The 403 error occurs when you don't use a valid API Key on an endpoint that requires authetication.)
   *   code 404 : Error (The 404 error can either be returned when some/all of parameters sent are not found within our system. This could be beacuse parameters like market, instrument, news source, symbol, asset_id etc. are invalid)
   ...
   * @param mappingPriority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST
   */
  def spotV1LatestInstrumentMetadata(market: String, instruments: Seq[String], groups: Seq[String], mappingPriority: Option[String] = None
): Request[Either[ResponseException[String, Exception], SPOTINSTRUMENTMETADATARESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/spot/v1/latest/instrument/metadata?market=${ market }&instruments=${ instruments }&groups=${ groups }&mapping_priority=${ mappingPriority }")
      .contentType("application/json")
      .response(asJson[SPOTINSTRUMENTMETADATARESPONSE])

  /**
   * Expected answers:
   *   code 200 : SPOTINSTRUMENTMARKETDATARESPONSE (Success response from the API.)
   *   code 400 : Error (The 400 error occurs when some of the data sent is malformed.)
   *   code 401 : Error (The 401 error occurs when you don't use a valid API Key on an endpoint that requires authetication.)
   *   code 403 : Error (The 403 error occurs when you don't use a valid API Key on an endpoint that requires authetication.)
   *   code 404 : Error (The 404 error can either be returned when some/all of parameters sent are not found within our system. This could be beacuse parameters like market, instrument, news source, symbol, asset_id etc. are invalid)
   ...
   * @param mappingPriority The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST
   */
  def spotV1LatestTick(market: String, instruments: Seq[String], groups: Seq[String], mappingPriority: Option[String] = None
): Request[Either[ResponseException[String, Exception], SPOTINSTRUMENTMARKETDATARESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/spot/v1/latest/tick?market=${ market }&instruments=${ instruments }&groups=${ groups }&mapping_priority=${ mappingPriority }")
      .contentType("application/json")
      .response(asJson[SPOTINSTRUMENTMARKETDATARESPONSE])
  ...
  def spotV1Markets(market: Option[String] = None
    ...
    basicRequest
      .method(Method.GET, uri"$baseUrl/spot/v1/markets?market=${ market }")
      .contentType("application/json")
      .response(asJson[GENERICRESPONSE])
   ...
   */
  def spotV1MarketsInstruments(market: Option[String] = None, instrument: Option[String] = None, instrumentStatus: Seq[String]
): Request[Either[ResponseException[String, Exception], GENERICRESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/spot/v1/markets/instruments?market=${ market }&instrument=${ instrument }&instrument_status=${ instrumentStatus }")
      .contentType("application/json")
      .response(asJson[GENERICRESPONSE])
   ...
   * @param instrumentStatus The status of the instrument, can be one of the following: ACTIVE, IGNORED, RETIRED, EXPIRED
   */
  def spotV1MarketsInstrumentsUnmapped(market: Option[String] = None, instrument: Option[String] = None, instrumentStatus: Seq[String]
): Request[Either[ResponseException[String, Exception], GENERICRESPONSE], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/spot/v1/markets/instruments/unmapped?market=${ market }&instrument=${ instrument }&instrument_status=${ instrumentStatus }")
      .contentType("application/json")
      .response(asJson[GENERICRESPONSE])
