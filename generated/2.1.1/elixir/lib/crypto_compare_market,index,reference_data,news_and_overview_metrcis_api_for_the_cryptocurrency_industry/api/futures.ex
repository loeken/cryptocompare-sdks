...
defmodule CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Api.Futures do
  @moduledoc """
  API calls for all endpoints tagged `Futures`.
  """
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_funding_rate_days(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_funding_rate_days(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :limit => :query,
      :to_ts => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_funding_rate_hours(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_funding_rate_hours(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :limit => :query,
      :to_ts => :query,
  ...
  - `instrument` (String.t): The mapped or unmapped instrument to retrieve on a specific market. We first check the instrument against the mapped list and then against the unmapped list          but you can use the mapping_priority param to check the unmapped list first.
  - `opts` (keyword): Optional parameters
    - `:after_ts` (integer()): Unix timestamp in seconds of the earliest funding rate message in the response
    ...
    - `:limit` (integer()): The maximum number of funding rate messages to return
    - `:mapping_priority` (String.t): The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST
    - `:response_format` (String.t): The format of the data response in uppercase. It can be one of the following: JSON,CSV
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_funding_rate_messages(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_funding_rate_messages(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :after_ts => :query,
      :last_ccseq => :query,
      :limit => :query,
  ...
  - `instrument` (String.t): The mapped or unmapped instrument to retrieve on a specific market. We first check the instrument against the mapped list and then against the unmapped list          but you can use the mapping_priority param to check the unmapped list first.
  - `opts` (keyword): Optional parameters
    - `:hour_ts` (integer()): Unix timestamp in seconds for the hour containing the funding rate updates you are interested in. You can pass any timestamp in the hour but we will round it down the the full hour timestmap and return all funding rate updates in that hour.
    - `:mapping_priority` (String.t): The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST
    - `:response_format` (String.t): The format of the data response in uppercase. It can be one of the following: JSON,CSV
    - `:return_404_on_empty_response` (boolean()): If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats.
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_funding_rate_messages_hour(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_funding_rate_messages_hour(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :hour_ts => :query,
      :mapping_priority => :query,
      :response_format => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_funding_rate_minutes(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_funding_rate_minutes(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :limit => :query,
      :to_ts => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_hours(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_hours(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :limit => :query,
      :to_ts => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_minutes(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_minutes(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :limit => :query,
      :to_ts => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_open_interest_days(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_open_interest_days(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :limit => :query,
      :to_ts => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_open_interest_hours(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_open_interest_hours(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :limit => :query,
      :to_ts => :query,
  ...
  - `instrument` (String.t): The mapped or unmapped instrument to retrieve on a specific market. We first check the instrument against the mapped list and then against the unmapped list          but you can use the mapping_priority param to check the unmapped list first.
  - `opts` (keyword): Optional parameters
    - `:after_ts` (integer()): Unix timestamp in seconds of the earliest open interest message in the response
    - `:last_ccseq` (integer()): The CCSEQ of the last message seen in the previous request. Useful for pagination within messages that happened in the same second. It will look though the messages in the same second and discard all messages until it reaches the CCSEQ from the last_ccseq parameter. If the CCSEQ is not part of that second, it will discard all messages in the second and only return messages starting from the next second onwards. When starting an integration with our API, on the first request, you should either not send a value for this paramater (defaults to 0 and does not discard any messages) or send 0. After you get a response use the TIMESTAMP and CCSEQ from the last message in the response. Pass the TIMESTAMP in the after_ts parameter and the CCSEQ in the last_ccseq parameter on your next request.
    - `:limit` (integer()): The maximum number of open interest messages to return
    - `:mapping_priority` (String.t): The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST
    - `:response_format` (String.t): The format of the data response in uppercase. It can be one of the following: JSON,CSV
    - `:return_404_on_empty_response` (boolean()): If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats.
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_open_interest_messages(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_open_interest_messages(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :after_ts => :query,
      :last_ccseq => :query,
      :limit => :query,
  ...
  - `instrument` (String.t): The mapped or unmapped instrument to retrieve on a specific market. We first check the instrument against the mapped list and then against the unmapped list          but you can use the mapping_priority param to check the unmapped list first.
  - `opts` (keyword): Optional parameters
    - `:hour_ts` (integer()): Unix timestamp in seconds for the hour containing the open interest updates you are interested in. You can pass any timestamp in the hour but we will round it down the the full hour timestmap and return all open interest updates in that hour.
    - `:mapping_priority` (String.t): The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST
    - `:response_format` (String.t): The format of the data response in uppercase. It can be one of the following: JSON,CSV
    - `:return_404_on_empty_response` (boolean()): If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats.
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_open_interest_messages_hour(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_open_interest_messages_hour(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :hour_ts => :query,
      :mapping_priority => :query,
      :response_format => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_open_interest_minutes(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_open_interest_minutes(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :limit => :query,
      :to_ts => :query,
  ...
  - `instrument` (String.t): The mapped or unmapped instrument to retrieve on a specific market. We first check the instrument against the mapped list and then against the unmapped list          but you can use the mapping_priority param to check the unmapped list first.
  - `opts` (keyword): Optional parameters
    - `:after_ts` (integer()): Unix timestamp in seconds of the earliest trade in the response.
    - `:last_ccseq` (integer()): The CCSEQ of the last message seen in the previous request. Useful for pagination within messages that happened in the same second. It will look though the messages in the same second and discard all messages until it reaches the CCSEQ from the last_ccseq parameter. If the CCSEQ is not part of that second, it will discard all messages in the second and only return messages starting from the next second onwards. When starting an integration with our API, on the first request, you should either not send a value for this paramater (defaults to 0 and does not discard any messages) or send 0. After you get a response use the TIMESTAMP and CCSEQ from the last message in the response. Pass the TIMESTAMP in the after_ts parameter and the CCSEQ in the last_ccseq parameter on your next request.
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_trades(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_trades(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :after_ts => :query,
      :last_ccseq => :query,
      :limit => :query,
  ...
  - `instrument` (String.t): The mapped or unmapped instrument to retrieve on a specific market. We first check the instrument against the mapped list and then against the unmapped list          but you can use the mapping_priority param to check the unmapped list first.
  - `opts` (keyword): Optional parameters
    - `:hour_ts` (integer()): Unix timestamp in seconds for the hour containing the trades you are interested in. You can pass any timestamp within an hour but we will round it down the the full hour timestmap and return all trades in that hour.
    - `:mapping_priority` (String.t): The mapping priority of the instrument. It is set to CHECK_MAPPED_FIRST by default. It can be one of the following: CHECK_MAPPED_FIRST,CHECK_UNMAPPED_FIRST
    - `:response_format` (String.t): The format of the data response in uppercase. It can be one of the following: JSON,CSV
    - `:return_404_on_empty_response` (boolean()): If set to false (default) then when there are no items to return, you will get a response status code of 200 and an empty JSON array or a CSV file with just the header. If set to true then when there are no items you will get a 404 status code for both JSON and CSV response_formats.
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_historical_trades_hour(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_historical_trades_hour(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :hour_ts => :query,
      :mapping_priority => :query,
      :response_format => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_latest_funding_rate_tick(Tesla.Env.client, String.t, list(String.t), keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_latest_funding_rate_tick(connection, market, instruments, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :mapping_priority => :query
    }
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_latest_instrument_metadata(Tesla.Env.client, String.t, list(String.t), keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_latest_instrument_metadata(connection, market, instruments, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :mapping_priority => :query
    }
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_latest_open_interest_tick(Tesla.Env.client, String.t, list(String.t), keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_latest_open_interest_tick(connection, market, instruments, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :mapping_priority => :query
    }
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_latest_tick(Tesla.Env.client, String.t, list(String.t), keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_latest_tick(connection, market, instruments, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :mapping_priority => :query
    }
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_markets(Tesla.Env.client, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_markets(connection, opts \\ []) do
    optional_params = %{
      :market => :query
    }
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_markets_instruments(Tesla.Env.client, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_markets_instruments(connection, opts \\ []) do
    optional_params = %{
      :market => :query,
      :instrument => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec futures_v1_markets_instruments_unmapped(Tesla.Env.client, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def futures_v1_markets_instruments_unmapped(connection, opts \\ []) do
    optional_params = %{
      :market => :query,
      :instrument => :query,
      :instrument_status => :query
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec index_v1_historical_days(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def index_v1_historical_days(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :limit => :query,
      :to_ts => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec index_v1_historical_hours(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def index_v1_historical_hours(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :limit => :query,
      :to_ts => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec index_v1_historical_messages(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def index_v1_historical_messages(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :after_ts => :query,
      :last_ccseq => :query,
      :limit => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec index_v1_historical_messages_hour(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def index_v1_historical_messages_hour(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :hour_ts => :query,
      :mapping_priority => :query,
      :response_format => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec index_v1_historical_minutes(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def index_v1_historical_minutes(connection, market, instrument, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :limit => :query,
      :to_ts => :query,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec index_v1_latest_instrument_metadata(Tesla.Env.client, String.t, list(String.t), keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def index_v1_latest_instrument_metadata(connection, market, instruments, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :mapping_priority => :query
    }
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec index_v1_latest_tick(Tesla.Env.client, String.t, list(String.t), keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def index_v1_latest_tick(connection, market, instruments, opts \\ []) do
    optional_params = %{
      :groups => :query,
      :mapping_priority => :query
    }
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec index_v1_markets(Tesla.Env.client, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def index_v1_markets(connection, opts \\ []) do
    optional_params = %{
      :market => :query
    }
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec index_v1_markets_instruments(Tesla.Env.client, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def index_v1_markets_instruments(connection, opts \\ []) do
    optional_params = %{
      :market => :query,
      :instrument => :query,
      :instrument_status => :query
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec index_v1_markets_instruments_unmapped(Tesla.Env.client, keyword()) :: {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.GenericResponse.t} | {:ok, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Model.Error.t} | {:error, Tesla.Env.t}
  def index_v1_markets_instruments_unmapped(connection, opts \\ []) do
    optional_params = %{
      :market => :query,
      :instrument => :query,
      :instrument_status => :query
