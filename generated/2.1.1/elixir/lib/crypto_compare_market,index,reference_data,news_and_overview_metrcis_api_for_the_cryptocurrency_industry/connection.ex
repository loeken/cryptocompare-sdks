...
defmodule CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Connection do
  @moduledoc """
  Handle Tesla connections for CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry.Connection,
        base_url: "https://data-api.cryptocompare.com",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :"crypto_compare_market,index,reference_data,news_and_overview_metrcis_api_for_the_cryptocurrency_industry",
        :base_url, "https://data-api.cryptocompare.com"
  """

  @default_base_url Application.compile_env(
                      :"crypto_compare_market,index,reference_data,news_and_overview_metrcis_api_for_the_cryptocurrency_industry",
                      :base_url,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:"crypto_compare_market,index,reference_data,news_and_overview_metrcis_api_for_the_cryptocurrency_industry", :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - CryptoCompareMarket,Index,ReferenceData,NewsAndOverviewMetrcisAPIForTheCryptocurrencyIndustry 2.1.1 - elixir"
        )
      )
