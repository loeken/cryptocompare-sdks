...
class ErrorErr(BaseModel):
    ...
    other_info: Optional[ErrorErrOtherInfo] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ErrorErr:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ErrorErr:
        """Create an instance of ErrorErr from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ErrorErr.parse_obj(obj)

        _obj = ErrorErr.parse_obj({
            "message": obj.get("message"),
            "other_info": ErrorErrOtherInfo.from_dict(obj.get("other_info")) if obj.get("other_info") is not None else None,
            "type": obj.get("type")
        })
        return _obj
