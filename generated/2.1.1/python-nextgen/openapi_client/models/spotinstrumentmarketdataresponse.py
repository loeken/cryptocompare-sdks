...
class SPOTINSTRUMENTMARKETDATARESPONSE(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    data: Optional[Dict[str, SPOTINSTRUMENTMARKETDATA]] = Field(None, alias="Data")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SPOTINSTRUMENTMARKETDATARESPONSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SPOTINSTRUMENTMARKETDATARESPONSE:
        """Create an instance of SPOTINSTRUMENTMARKETDATARESPONSE from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SPOTINSTRUMENTMARKETDATARESPONSE.parse_obj(obj)

        _obj = SPOTINSTRUMENTMARKETDATARESPONSE.parse_obj({
            "data": dict((_k, Dict[str, SPOTINSTRUMENTMARKETDATA].from_dict(_v)) for _k, _v in obj.get("Data").items()),
