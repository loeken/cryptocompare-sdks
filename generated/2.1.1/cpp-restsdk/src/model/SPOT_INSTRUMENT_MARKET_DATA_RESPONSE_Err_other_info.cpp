...
#include "CppRestOpenAPIClient/model/SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info.h"
...
void SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info::validate()
{
    // TODO: implement validation
}

web::json::value SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info::toJson() const
{
...
bool SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info::getParam() const
{
    return m_Param;
}

void SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info::setParam(const utility::string_t& value)
{
    m_Param = value;
    m_ParamIsSet = true;
}

bool SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info::paramIsSet() const
{
    return m_ParamIsSet;
}

void SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info::unsetParam()
{
    m_ParamIsSet = false;
}
std::vector<utility::string_t>& SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info::getValues()
{
    return m_Values;
}

void SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info::setValues(const std::vector<utility::string_t>& value)
{
    m_Values = value;
    m_ValuesIsSet = true;
}

bool SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info::valuesIsSet() const
{
    return m_ValuesIsSet;
}

void SPOT_INSTRUMENT_MARKET_DATA_RESPONSE_Err_other_info::unsetValues()
{
    m_ValuesIsSet = false;
}
}
